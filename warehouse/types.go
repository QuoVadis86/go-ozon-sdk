...
const (
	FirstMileTypeEnumUnspecified FirstMileTypeEnum = "UNSPECIFIED"
	FirstMileTypeEnumPickUP      FirstMileTypeEnum = "PICK_UP"
	FirstMileTypeEnumDropOFF     FirstMileTypeEnum = "DROP_OFF"
)
