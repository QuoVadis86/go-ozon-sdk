...
// 搜索参数。
// 揽收点类型：
type ListDropOffPointsForCreateFBSWarehouseRequestSearchTypesEnum string
const (
	ListDropOffPointsForCreateFBSWarehouseRequestSearchTypesEnum_PVZ ListDropOffPointsForCreateFBSWarehouseRequestSearchTypesEnum = "PVZ"
	ListDropOffPointsForCreateFBSWarehouseRequestSearchTypesEnum_PPZ ListDropOffPointsForCreateFBSWarehouseRequestSearchTypesEnum = "PPZ"
	ListDropOffPointsForCreateFBSWarehouseRequestSearchTypesEnum_SC ListDropOffPointsForCreateFBSWarehouseRequestSearchTypesEnum = "SC"
)
...
// 查找快递方式的过滤器。
// 快递方式状态:
type DeliveryMethodListRequestFilterStatusEnum string
const (
	DeliveryMethodListRequestFilterStatusEnum_NEW DeliveryMethodListRequestFilterStatusEnum = "NEW"
	DeliveryMethodListRequestFilterStatusEnum_EDITED DeliveryMethodListRequestFilterStatusEnum = "EDITED"
	DeliveryMethodListRequestFilterStatusEnum_ACTIVE DeliveryMethodListRequestFilterStatusEnum = "ACTIVE"
	DeliveryMethodListRequestFilterStatusEnum_DISABLED DeliveryMethodListRequestFilterStatusEnum = "DISABLED"
)

type DeliveryMethodListRequestFilter struct {
	ProviderID int64 `json:"provider_id"` // 快递服务识别号。
	Status DeliveryMethodListRequestFilterStatusEnum `json:"status"` // 快递方式状态: - `NEW` — 已创建, - `EDITED` — 正在编辑, - `ACTIVE` — 已激活, - `DISABLED` — 未激活。
...
// 快递方式状态:
type DeliveryMethodListResponseDeliveryMethodStatusEnum string
const (
	DeliveryMethodListResponseDeliveryMethodStatusEnum_NEW DeliveryMethodListResponseDeliveryMethodStatusEnum = "NEW"
	DeliveryMethodListResponseDeliveryMethodStatusEnum_EDITED DeliveryMethodListResponseDeliveryMethodStatusEnum = "EDITED"
	DeliveryMethodListResponseDeliveryMethodStatusEnum_ACTIVE DeliveryMethodListResponseDeliveryMethodStatusEnum = "ACTIVE"
	DeliveryMethodListResponseDeliveryMethodStatusEnum_DISABLED DeliveryMethodListResponseDeliveryMethodStatusEnum = "DISABLED"
)
...
type DeliveryMethodListResponseDeliveryMethod struct {
	...
	Status DeliveryMethodListResponseDeliveryMethodStatusEnum `json:"status"` // 快递方式状态: - `NEW` — 已创建, - `EDITED` — 正在编辑, - `ACTIVE` — 已激活, - `DISABLED` — 未激活。
...
type WarehouseDeliveryMethodListResponse struct {
	...
	Result []DeliveryMethodListResponseDeliveryMethod `json:"result"` // 查询结果。
}
...
// 配送方式状态：
type DeliveryMethodListV2ResponseDeliveryMethodStatusEnum string
const (
	DeliveryMethodListV2ResponseDeliveryMethodStatusEnum_NEW DeliveryMethodListV2ResponseDeliveryMethodStatusEnum = "NEW"
	DeliveryMethodListV2ResponseDeliveryMethodStatusEnum_EDITED DeliveryMethodListV2ResponseDeliveryMethodStatusEnum = "EDITED"
	DeliveryMethodListV2ResponseDeliveryMethodStatusEnum_ACTIVE DeliveryMethodListV2ResponseDeliveryMethodStatusEnum = "ACTIVE"
	DeliveryMethodListV2ResponseDeliveryMethodStatusEnum_DISABLED DeliveryMethodListV2ResponseDeliveryMethodStatusEnum = "DISABLED"
	DeliveryMethodListV2ResponseDeliveryMethodStatusEnum_WAITING DeliveryMethodListV2ResponseDeliveryMethodStatusEnum = "WAITING"
	DeliveryMethodListV2ResponseDeliveryMethodStatusEnum_BROKEN DeliveryMethodListV2ResponseDeliveryMethodStatusEnum = "BROKEN"
)

// 与配送服务的集成类型：
type DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum string
const (
	DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum_Aggregator DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum = "aggregator"
	DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum_V3plTracking DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum = "3pl_tracking"
	DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum_NonIntegrated DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum = "non_integrated"
	DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum_Hybrid DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum = "hybrid"
)
...
type DeliveryMethodListV2ResponseDeliveryMethod struct {
	...
	Status DeliveryMethodListV2ResponseDeliveryMethodStatusEnum `json:"status"` // 配送方式状态： - `NEW`：已创建， - `EDITED`：编辑中， - `ACTIVE`：已启用， - `DISABLED`：未启用， - `WAITING`：审核中， - `BROKEN`：异常。
	...
	TPLIntegrationType DeliveryMethodListV2ResponseDeliveryMethodTPLIntegrationTypeEnum `json:"tpl_integration_type"` // 与配送服务的集成类型： - `aggregator`：由第三方配送，Ozon负责登记订单； - `3pl_tracking`：由第三方配送，卖家负责登记订单； - `non_integrated`：由卖家自行配送； - `hybrid`：混...
...
type V2DeliveryMethodListV2Response struct {
	...
	DeliveryMethods []DeliveryMethodListV2ResponseDeliveryMethod `json:"delivery_methods"` // 配送方式。
...
// 用于搜索配送方式的筛选条件。
// 配送方式状态：
type DeliveryMethodListV2RequestFilterStatusEnum string
const (
	DeliveryMethodListV2RequestFilterStatusEnum_NEW DeliveryMethodListV2RequestFilterStatusEnum = "NEW"
	DeliveryMethodListV2RequestFilterStatusEnum_EDITED DeliveryMethodListV2RequestFilterStatusEnum = "EDITED"
	DeliveryMethodListV2RequestFilterStatusEnum_ACTIVE DeliveryMethodListV2RequestFilterStatusEnum = "ACTIVE"
	DeliveryMethodListV2RequestFilterStatusEnum_DISABLED DeliveryMethodListV2RequestFilterStatusEnum = "DISABLED"
	DeliveryMethodListV2RequestFilterStatusEnum_WAITING DeliveryMethodListV2RequestFilterStatusEnum = "WAITING"
	DeliveryMethodListV2RequestFilterStatusEnum_BROKEN DeliveryMethodListV2RequestFilterStatusEnum = "BROKEN"
)
...
// 第一英里 FBS。
// 第一英里的类型 — `DropOff` 或 `Pickup`
type WarehouseFirstMileTypeFirstMileTypeEnum string
const (
	WarehouseFirstMileTypeFirstMileTypeEnum_DropOff WarehouseFirstMileTypeFirstMileTypeEnum = "DropOff"
	WarehouseFirstMileTypeFirstMileTypeEnum_Pickup WarehouseFirstMileTypeFirstMileTypeEnum = "Pickup"
)
...
type WarehouseFirstMileType struct {
	...
	FirstMileType WarehouseFirstMileTypeFirstMileTypeEnum `json:"first_mile_type"` // 第一英里的类型 — `DropOff` 或 `Pickup`。
	DropoffPointID string `json:"dropoff_point_id"` // DropOff-点识别号。
}

// 仓库状况
type WarehouseListResponseWarehouseStatusEnum string
const (
	WarehouseListResponseWarehouseStatusEnum_New WarehouseListResponseWarehouseStatusEnum = "new"
	WarehouseListResponseWarehouseStatusEnum_Created WarehouseListResponseWarehouseStatusEnum = "created"
	WarehouseListResponseWarehouseStatusEnum_Disabled WarehouseListResponseWarehouseStatusEnum = "disabled"
	WarehouseListResponseWarehouseStatusEnum_Blocked WarehouseListResponseWarehouseStatusEnum = "blocked"
	WarehouseListResponseWarehouseStatusEnum_DisabledDueToLimit WarehouseListResponseWarehouseStatusEnum = "disabled_due_to_limit"
	WarehouseListResponseWarehouseStatusEnum_Error WarehouseListResponseWarehouseStatusEnum = "error"
)
...
type WarehouseListResponseWarehouse struct {
	...
	Status WarehouseListResponseWarehouseStatusEnum `json:"status"` // 仓库状况。 仓库状态与个人账户中的状态的对应关系: | 状态 Seller&nbsp;API | 个人账户中的状态 | |---|---| | `new` | 正在激活 | | `created` | 已激活 | | `disabled` ...
...
type WarehouseWarehouseListResponse struct {
	Result []WarehouseListResponseWarehouse `json:"result"` // 仓库清单。
}
...
// 仓库工作日：
type WarehouseListV2ResponseWarehouseWorkingDaysEnum string
const (
	WarehouseListV2ResponseWarehouseWorkingDaysEnum_UNSPECIFIED WarehouseListV2ResponseWarehouseWorkingDaysEnum = "UNSPECIFIED"
	WarehouseListV2ResponseWarehouseWorkingDaysEnum_MONDAY WarehouseListV2ResponseWarehouseWorkingDaysEnum = "MONDAY"
	WarehouseListV2ResponseWarehouseWorkingDaysEnum_TUESDAY WarehouseListV2ResponseWarehouseWorkingDaysEnum = "TUESDAY"
	WarehouseListV2ResponseWarehouseWorkingDaysEnum_WEDNESDAY WarehouseListV2ResponseWarehouseWorkingDaysEnum = "WEDNESDAY"
	WarehouseListV2ResponseWarehouseWorkingDaysEnum_THURSDAY WarehouseListV2ResponseWarehouseWorkingDaysEnum = "THURSDAY"
	WarehouseListV2ResponseWarehouseWorkingDaysEnum_FRIDAY WarehouseListV2ResponseWarehouseWorkingDaysEnum = "FRIDAY"
	WarehouseListV2ResponseWarehouseWorkingDaysEnum_SATURDAY WarehouseListV2ResponseWarehouseWorkingDaysEnum = "SATURDAY"
	WarehouseListV2ResponseWarehouseWorkingDaysEnum_SUNDAY WarehouseListV2ResponseWarehouseWorkingDaysEnum = "SUNDAY"
)
...
type WarehouseListV2ResponseWarehouse struct {
	...
	WorkingDays []WarehouseWorkingDaysEnum `json:"working_days"` // 仓库工作日： - `UNSPECIFIED` — 值未确定； - `MONDAY` — 星期一； - `TUESDAY` — 星期二； - `WEDNESDAY` — 星期三； - `THURSDAY` — 星期四； - `FRIDAY` ...
...
type V2WarehouseListV2Response struct {
	...
	Warehouses []WarehouseListV2ResponseWarehouse `json:"warehouses"` // 仓库列表。
...
// 搜索参数。
// 揽收点类型：
type ListDropOffPointsForUpdateFBSWarehouseRequestSearchTypesEnum string
const (
	ListDropOffPointsForUpdateFBSWarehouseRequestSearchTypesEnum_PVZ ListDropOffPointsForUpdateFBSWarehouseRequestSearchTypesEnum = "PVZ"
	ListDropOffPointsForUpdateFBSWarehouseRequestSearchTypesEnum_PPZ ListDropOffPointsForUpdateFBSWarehouseRequestSearchTypesEnum = "PPZ"
	ListDropOffPointsForUpdateFBSWarehouseRequestSearchTypesEnum_SC ListDropOffPointsForUpdateFBSWarehouseRequestSearchTypesEnum = "SC"
)
...
type V1WarehouseInvalidProductsGetResponse struct {
	...
	ValidationResults []WarehouseInvalidProductsGetResponseValidationResult `json:"validation_results"` // 检查结果。
}
...
// 仓库工作日：
type V1CreateWarehouseFBSRequestWorkingDaysEnum string
const (
	V1CreateWarehouseFBSRequestWorkingDaysEnum_MONDAY V1CreateWarehouseFBSRequestWorkingDaysEnum = "MONDAY"
	V1CreateWarehouseFBSRequestWorkingDaysEnum_TUESDAY V1CreateWarehouseFBSRequestWorkingDaysEnum = "TUESDAY"
	V1CreateWarehouseFBSRequestWorkingDaysEnum_WEDNESDAY V1CreateWarehouseFBSRequestWorkingDaysEnum = "WEDNESDAY"
	V1CreateWarehouseFBSRequestWorkingDaysEnum_THURSDAY V1CreateWarehouseFBSRequestWorkingDaysEnum = "THURSDAY"
	V1CreateWarehouseFBSRequestWorkingDaysEnum_FRIDAY V1CreateWarehouseFBSRequestWorkingDaysEnum = "FRIDAY"
	V1CreateWarehouseFBSRequestWorkingDaysEnum_SATURDAY V1CreateWarehouseFBSRequestWorkingDaysEnum = "SATURDAY"
	V1CreateWarehouseFBSRequestWorkingDaysEnum_SUNDAY V1CreateWarehouseFBSRequestWorkingDaysEnum = "SUNDAY"
)
