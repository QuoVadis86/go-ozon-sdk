...
type ListDropOffPointsForUpdateFBSWarehouseResponseDropOffPointDropOffPointType string

const (
	ListDropOffPointsForUpdateFBSWarehouseResponseDropOffPointDropOffPointTypePVZ ListDropOffPointsForUpdateFBSWarehouseResponseDropOffPointDropOffPointType = "PVZ"
	ListDropOffPointsForUpdateFBSWarehouseResponseDropOffPointDropOffPointTypePPZ ListDropOffPointsForUpdateFBSWarehouseResponseDropOffPointDropOffPointType = "PPZ"
	ListDropOffPointsForUpdateFBSWarehouseResponseDropOffPointDropOffPointTypeSC  ListDropOffPointsForUpdateFBSWarehouseResponseDropOffPointDropOffPointType = "SC"
)
...
type ListDropOffPointsForUpdateFBSWarehouseResponseDropOffPoint struct {
	...
	Type                 ListDropOffPointsForUpdateFBSWarehouseResponseDropOffPointDropOffPointType `json:"type_"`
...
const (
	WorkingDaysUnspecified WorkingDays = "UNSPECIFIED"
	WorkingDaysMonday      WorkingDays = "MONDAY"
	WorkingDaysTuesday     WorkingDays = "TUESDAY"
	WorkingDaysWednesday   WorkingDays = "WEDNESDAY"
	WorkingDaysThursday    WorkingDays = "THURSDAY"
	WorkingDaysFriday      WorkingDays = "FRIDAY"
	WorkingDaysSaturday    WorkingDays = "SATURDAY"
	WorkingDaysSunday      WorkingDays = "SUNDAY"
)
...
type FirstMileType string

const (
	FirstMileTypeUnspecified FirstMileType = "UNSPECIFIED"
	FirstMileTypePickUP      FirstMileType = "PICK_UP"
	FirstMileTypeDropOFF     FirstMileType = "DROP_OFF"
)
...
type ListDropOffPointsForCreateFBSWarehouseRequestSearchDropOffPointType string

const (
	ListDropOffPointsForCreateFBSWarehouseRequestSearchDropOffPointTypePVZ ListDropOffPointsForCreateFBSWarehouseRequestSearchDropOffPointType = "PVZ"
	ListDropOffPointsForCreateFBSWarehouseRequestSearchDropOffPointTypePPZ ListDropOffPointsForCreateFBSWarehouseRequestSearchDropOffPointType = "PPZ"
	ListDropOffPointsForCreateFBSWarehouseRequestSearchDropOffPointTypeSC  ListDropOffPointsForCreateFBSWarehouseRequestSearchDropOffPointType = "SC"
)
...
const (
	...
	StatusEdited   Status = "EDITED"   // ：编辑中
	StatusActive   Status = "ACTIVE"   // ：已启用
	StatusDisabled Status = "DISABLED" // ：未启用
	StatusWaiting  Status = "WAITING"  // ：审核中
	StatusBroken   Status = "BROKEN"   // ：异常
)
...
type ValidationErrorCharacteristic string

const (
	ValidationErrorCharacteristicUnspecified     ValidationErrorCharacteristic = "UNSPECIFIED"
	ValidationErrorCharacteristicLength          ValidationErrorCharacteristic = "LENGTH"
	ValidationErrorCharacteristicWidth           ValidationErrorCharacteristic = "WIDTH"
	ValidationErrorCharacteristicHeight          ValidationErrorCharacteristic = "HEIGHT"
	ValidationErrorCharacteristicWeight          ValidationErrorCharacteristic = "WEIGHT"
	ValidationErrorCharacteristicSUMOFDimensions ValidationErrorCharacteristic = "SUM_OF_DIMENSIONS"
	ValidationErrorCharacteristicVolumeWeight    ValidationErrorCharacteristic = "VOLUME_WEIGHT"
	ValidationErrorCharacteristicVolume          ValidationErrorCharacteristic = "VOLUME"
	ValidationErrorCharacteristicPrice           ValidationErrorCharacteristic = "PRICE"
	ValidationErrorCharacteristicLongestSide     ValidationErrorCharacteristic = "LONGEST_SIDE"
)

// D揽收点类型： - `PVZ` — 订单取货点， - `PPZ` — 订单接收点， - `SC` — 分拣中心。
type V1ListDropOffPointsForCreateFBSWarehouseResponseDropOffPointType string

const (
	V1ListDropOffPointsForCreateFBSWarehouseResponseDropOffPointTypePVZ V1ListDropOffPointsForCreateFBSWarehouseResponseDropOffPointType = "PVZ"
	V1ListDropOffPointsForCreateFBSWarehouseResponseDropOffPointTypePPZ V1ListDropOffPointsForCreateFBSWarehouseResponseDropOffPointType = "PPZ"
	V1ListDropOffPointsForCreateFBSWarehouseResponseDropOffPointTypeSC  V1ListDropOffPointsForCreateFBSWarehouseResponseDropOffPointType = "SC"
)
...
type CreateWarehouseFBSRequestFirstMileType string

const (
	CreateWarehouseFBSRequestFirstMileTypePickUP  CreateWarehouseFBSRequestFirstMileType = "PICK_UP"
	CreateWarehouseFBSRequestFirstMileTypeDropOFF CreateWarehouseFBSRequestFirstMileType = "DROP_OFF"
)

type FilterStatus string

const (
	FilterStatusNEW      FilterStatus = "NEW"
	FilterStatusEdited   FilterStatus = "EDITED"
	FilterStatusActive   FilterStatus = "ACTIVE"
	FilterStatusDisabled FilterStatus = "DISABLED"
	FilterStatusWaiting  FilterStatus = "WAITING"
	FilterStatusBroken   FilterStatus = "BROKEN"
)

// 操作状态： - `UNSPECIFIED` — 未定义； - `IN_PROGRESS` — 进行中； - `SUCCESS` — 已完成； - `ERROR` — 出错结束。
type GetWarehouseFBSOperationStatusResponseStatus string

const (
	GetWarehouseFBSOperationStatusResponseStatusUnspecified GetWarehouseFBSOperationStatusResponseStatus = "UNSPECIFIED"
	GetWarehouseFBSOperationStatusResponseStatusINProgress  GetWarehouseFBSOperationStatusResponseStatus = "IN_PROGRESS"
	GetWarehouseFBSOperationStatusResponseStatusSuccess     GetWarehouseFBSOperationStatusResponseStatus = "SUCCESS"
	GetWarehouseFBSOperationStatusResponseStatusError       GetWarehouseFBSOperationStatusResponseStatus = "ERROR"
)
...
type V1UpdateWarehouseFBSRequestWorkingDays string

const (
	V1UpdateWarehouseFBSRequestWorkingDaysMonday    V1UpdateWarehouseFBSRequestWorkingDays = "MONDAY"
	V1UpdateWarehouseFBSRequestWorkingDaysTuesday   V1UpdateWarehouseFBSRequestWorkingDays = "TUESDAY"
	V1UpdateWarehouseFBSRequestWorkingDaysWednesday V1UpdateWarehouseFBSRequestWorkingDays = "WEDNESDAY"
	V1UpdateWarehouseFBSRequestWorkingDaysThursday  V1UpdateWarehouseFBSRequestWorkingDays = "THURSDAY"
	V1UpdateWarehouseFBSRequestWorkingDaysFriday    V1UpdateWarehouseFBSRequestWorkingDays = "FRIDAY"
	V1UpdateWarehouseFBSRequestWorkingDaysSaturday  V1UpdateWarehouseFBSRequestWorkingDays = "SATURDAY"
	V1UpdateWarehouseFBSRequestWorkingDaysSunday    V1UpdateWarehouseFBSRequestWorkingDays = "SUNDAY"
)
...
type V1UpdateWarehouseFBSRequest struct {
	...
	WorkingDays        []V1UpdateWarehouseFBSRequestWorkingDays      `json:"working_days"` // 仓库工作日： - `MONDAY` — 周一； - `TUESDAY` — 周二； - `WEDNESDAY` — 周三； - `THURSDAY` — 周四； - `FRIDAY` — 周五； - `SATURDAY` — 周六； - `...
}

type CreateWarehouseFBSRequestWorkingDays string

const (
	CreateWarehouseFBSRequestWorkingDaysMonday    CreateWarehouseFBSRequestWorkingDays = "MONDAY"
	CreateWarehouseFBSRequestWorkingDaysTuesday   CreateWarehouseFBSRequestWorkingDays = "TUESDAY"
	CreateWarehouseFBSRequestWorkingDaysWednesday CreateWarehouseFBSRequestWorkingDays = "WEDNESDAY"
	CreateWarehouseFBSRequestWorkingDaysThursday  CreateWarehouseFBSRequestWorkingDays = "THURSDAY"
	CreateWarehouseFBSRequestWorkingDaysFriday    CreateWarehouseFBSRequestWorkingDays = "FRIDAY"
	CreateWarehouseFBSRequestWorkingDaysSaturday  CreateWarehouseFBSRequestWorkingDays = "SATURDAY"
	CreateWarehouseFBSRequestWorkingDaysSunday    CreateWarehouseFBSRequestWorkingDays = "SUNDAY"
)
...
type ListDropOffPointsForUpdateFBSWarehouseRequestSearchDropOffPointType string

const (
	ListDropOffPointsForUpdateFBSWarehouseRequestSearchDropOffPointTypePVZ ListDropOffPointsForUpdateFBSWarehouseRequestSearchDropOffPointType = "PVZ"
	ListDropOffPointsForUpdateFBSWarehouseRequestSearchDropOffPointTypePPZ ListDropOffPointsForUpdateFBSWarehouseRequestSearchDropOffPointType = "PPZ"
	ListDropOffPointsForUpdateFBSWarehouseRequestSearchDropOffPointTypeSC  ListDropOffPointsForUpdateFBSWarehouseRequestSearchDropOffPointType = "SC"
)

// 第一英里类型： - `PICK_UP` —发运给快递员； - `DROP_OFF` —发运至接收点。
type V1UpdateWarehouseFBSFirstMileRequestFirstMileType string

const (
	V1UpdateWarehouseFBSFirstMileRequestFirstMileTypePickUP  V1UpdateWarehouseFBSFirstMileRequestFirstMileType = "PICK_UP"
	V1UpdateWarehouseFBSFirstMileRequestFirstMileTypeDropOFF V1UpdateWarehouseFBSFirstMileRequestFirstMileType = "DROP_OFF"
)
...
type ValidationResultItemState string

const (
	ValidationResultItemStateUnspecified ValidationResultItemState = "UNSPECIFIED"
	ValidationResultItemStateNOTValid    ValidationResultItemState = "NOT_VALID"
)
...
type ValidationResultValidationErrorType string

const (
	ValidationResultValidationErrorTypeUnspecified    ValidationResultValidationErrorType = "UNSPECIFIED"
	ValidationResultValidationErrorTypeLessThanMIN    ValidationResultValidationErrorType = "LESS_THAN_MIN"
	ValidationResultValidationErrorTypeGreaterThanMAX ValidationResultValidationErrorType = "GREATER_THAN_MAX"
)

type ValidationResultValidationError struct {
	Characteristic   ValidationErrorCharacteristic       `json:"characteristic"`
	...
	Type             ValidationResultValidationErrorType `json:"type_"`
}

type InvalidProductsGetResponseValidationResult struct {
	Item             ValidationResultItem              `json:"item"`
	State            ValidationResultItemState         `json:"state"`
...
type ListDropOffPointsForCreateFBSWarehouseResponseDropOffPoint struct {
	Type                 V1ListDropOffPointsForCreateFBSWarehouseResponseDropOffPointType `json:"type_"`
	Address              string                                                           `json:"address"` // 揽收点地址。
...
type ListDropOffPointsForUpdateFBSWarehouseRequestSearch struct {
	Types   []ListDropOffPointsForUpdateFBSWarehouseRequestSearchDropOffPointType `json:"types"`   // 揽收点类型： - `PVZ` — 订单取货点， - `PPZ` — 订单接收点， - `SC` — 分拣中心。
...
type ListDropOffPointsForCreateFBSWarehouseRequestSearch struct {
	Address string                                                                `json:"address"` // 揽收点地址。
	Types   []ListDropOffPointsForCreateFBSWarehouseRequestSearchDropOffPointType `json:"types"`   // 揽收点类型： - `PVZ` — 订单取货点， - `PPZ` — 订单接收点， - `SC` — 分拣中心。
}
...
// 排序方向： - `ASC`：升序， - `DESC`：降序。
type MethodListV2RequestSortDir string

const (
	MethodListV2RequestSortDirASC  MethodListV2RequestSortDir = "ASC"
	MethodListV2RequestSortDirDesc MethodListV2RequestSortDir = "DESC"
)
...
type MethodListV2RequestFilter struct {
	...
	Status            []FilterStatus `json:"status"`              // 配送方式状态： - `NEW`：已创建， - `EDITED`：编辑中， - `ACTIVE`：已启用， - `DISABLED`：未启用， - `WAITING`：审核中， - `BROKEN`：异常。
...
type V2DeliveryMethodListV2Request struct {
	SortDir MethodListV2RequestSortDir `json:"sort_dir"`
	Cursor  string                     `json:"cursor"` // 用于选择下一批数据的指针。
...
type CarriageLabelType string

const (
	CarriageLabelTypeUnspecified CarriageLabelType = "UNSPECIFIED"
	CarriageLabelTypeBIG         CarriageLabelType = "BIG"
	CarriageLabelTypeSmall       CarriageLabelType = "SMALL"
)
...
type ListV2ResponseWarehouse struct {
	...
	WorkingDays            []WorkingDays     `json:"working_days"` // 仓库工作日： - `UNSPECIFIED` — 值未确定； - `MONDAY` — 星期一； - `TUESDAY` — 星期二； - `WEDNESDAY` — 星期三； - `THURSDAY` — 星期四； - `FRIDAY` ...
	AddressInfo            AddressInfo       `json:"address_info"`
	CarriageLabelType      CarriageLabelType `json:"carriage_label_type"`
...
type GetWarehouseFBSOperationStatusResponseType string

const (
	GetWarehouseFBSOperationStatusResponseTypeUnspecified            GetWarehouseFBSOperationStatusResponseType = "UNSPECIFIED"
	GetWarehouseFBSOperationStatusResponseTypeCreateFBSWarehouse     GetWarehouseFBSOperationStatusResponseType = "CREATE_FBS_WAREHOUSE"
	GetWarehouseFBSOperationStatusResponseTypeUpdateFBSWarehouse     GetWarehouseFBSOperationStatusResponseType = "UPDATE_FBS_WAREHOUSE"
	GetWarehouseFBSOperationStatusResponseTypeSETFirstMile           GetWarehouseFBSOperationStatusResponseType = "SET_FIRST_MILE"
	GetWarehouseFBSOperationStatusResponseTypeWarehouseEnableDisable GetWarehouseFBSOperationStatusResponseType = "WAREHOUSE_ENABLE_DISABLE"
)

type V1GetWarehouseFBSOperationStatusResponse struct {
	Type   GetWarehouseFBSOperationStatusResponseType   `json:"type_"`
	...
	Status GetWarehouseFBSOperationStatusResponseStatus `json:"status"`
}
...
type V1UpdateWarehouseFBSFirstMileRequest struct {
	...
	FirstMileType  V1UpdateWarehouseFBSFirstMileRequestFirstMileType `json:"first_mile_type"`
}
...
type V1CreateWarehouseFBSRequest struct {
	...
	CutInTime          int64                                       `json:"cut_in_time"`       // 接单时间（分钟）。例如，如果传入 `3000`，则接单将在传入后50小时内结束。
	DropOffPointID     int64                                       `json:"drop_off_point_id"` // 揽收点标识符。
	FirstMileType      CreateWarehouseFBSRequestFirstMileType      `json:"first_mile_type"`
	Options            CreateWarehouseFBSRequestOptions            `json:"options"`
	WorkingDays        []CreateWarehouseFBSRequestWorkingDays      `json:"working_days"` // 仓库工作日： - `MONDAY` — 星期一， - `TUESDAY` — 星期二， - `WEDNESDAY` — 星期三， - `THURSDAY` — 星期四， - `FRIDAY` — 星期五， - `SATURDAY` — 星期...
	IsKgt              bool                                        `json:"is_kgt"`       // `true`表示商品为超大。
	Name               string                                      `json:"name"`         // 仓库名称。
