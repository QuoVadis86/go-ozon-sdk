...
const (
	WorkingDaysMonday    WorkingDays = "MONDAY"    // 周一；
	WorkingDaysTuesday   WorkingDays = "TUESDAY"   // 周二；
	WorkingDaysWednesday WorkingDays = "WEDNESDAY" // 周三；
	WorkingDaysThursday  WorkingDays = "THURSDAY"  // 周四；
	WorkingDaysFriday    WorkingDays = "FRIDAY"    // 周五；
	WorkingDaysSaturday  WorkingDays = "SATURDAY"  // 周六；
	WorkingDaysSunday    WorkingDays = "SUNDAY"    // 周日。
)
