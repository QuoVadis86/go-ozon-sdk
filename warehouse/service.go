...
// 创建仓库
// Note: 请使用方法[/v1/warehouse/fbs/create/drop-off/list](#operation/WarehouseAPI_ListDropOffPointsForCreateFBSWarehouse)获取点位列表。
...
// 仓库列表
// Note: 请使用 [/v1/warehouse/fbo/list](https://docs.
// Note: 要获取 FBO 仓库列表，请使用 [/v1/warehouse/fbo/list](https://docs.
