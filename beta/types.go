...
// 标志代码类型：
type V5FbsPostingProductExemplarValidateV5ResponseProductExemplarMarkMarkTypeEnum string
const (
	V5FbsPostingProductExemplarValidateV5ResponseProductExemplarMarkMarkTypeEnum_MandatoryMark V5FbsPostingProductExemplarValidateV5ResponseProductExemplarMarkMarkTypeEnum = "mandatory_mark"
	V5FbsPostingProductExemplarValidateV5ResponseProductExemplarMarkMarkTypeEnum_JwUin V5FbsPostingProductExemplarValidateV5ResponseProductExemplarMarkMarkTypeEnum = "jw_uin"
	V5FbsPostingProductExemplarValidateV5ResponseProductExemplarMarkMarkTypeEnum_Imei V5FbsPostingProductExemplarValidateV5ResponseProductExemplarMarkMarkTypeEnum = "imei"
)
...
type V5FbsPostingProductExemplarValidateV5ResponseProductExemplarMark struct {
	...
	MarkType V5FbsPostingProductExemplarValidateV5ResponseProductExemplarMarkMarkTypeEnum `json:"mark_type"` // 标志代码类型： - `mandatory_mark` — “诚实标志”（Chestny ZNAK）强制性标志； - `jw_uin` — 珠宝制品的唯 一 识别编号； - `imei` — 移动设备 IMEI。
...
type FinanceV1GetFinanceAccrualPostingsResponse struct {
	PostingAccruals []FinanceV1GetFinanceAccrualPostingsResponsePostingAccruals `json:"posting_accruals"` // 按货件统计的应计项目列表。
}
...
// 标志代码类型：
type V5FbsPostingProductExemplarValidateV5RequestProductExemplarMarkMarkTypeEnum string
const (
	V5FbsPostingProductExemplarValidateV5RequestProductExemplarMarkMarkTypeEnum_MandatoryMark V5FbsPostingProductExemplarValidateV5RequestProductExemplarMarkMarkTypeEnum = "mandatory_mark"
	V5FbsPostingProductExemplarValidateV5RequestProductExemplarMarkMarkTypeEnum_JwUin V5FbsPostingProductExemplarValidateV5RequestProductExemplarMarkMarkTypeEnum = "jw_uin"
	V5FbsPostingProductExemplarValidateV5RequestProductExemplarMarkMarkTypeEnum_Imei V5FbsPostingProductExemplarValidateV5RequestProductExemplarMarkMarkTypeEnum = "imei"
)

type V5FbsPostingProductExemplarValidateV5RequestProductExemplarMark struct {
	Mark string `json:"mark"` // 标志代码的值。
	MarkType V5FbsPostingProductExemplarValidateV5RequestProductExemplarMarkMarkTypeEnum `json:"mark_type"` // 标志代码类型： - `mandatory_mark` — “诚实标志”（Chestny ZNAK）强制性标志； - `jw_uin` — 珠宝制品的唯 一 识别编号； - `imei` — 移动设备 IMEI。
}
...
type ProductV1ProductVisibilityInfoResponse struct {
	Items []ProductV1ProductVisibilityInfoResponseItem `json:"items"` // 商品列表。
}

// 检查状态：
type V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkCheckStatusEnum string
const (
	V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkCheckStatusEnum_Processing V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkCheckStatusEnum = "processing"
	V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkCheckStatusEnum_Failed V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkCheckStatusEnum = "failed"
	V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkCheckStatusEnum_Passed V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkCheckStatusEnum = "passed"
)

// 标志代码类型：
type V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkMarkTypeEnum string
const (
	V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkMarkTypeEnum_MandatoryMark V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkMarkTypeEnum = "mandatory_mark"
	V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkMarkTypeEnum_JwUin V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkMarkTypeEnum = "jw_uin"
	V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkMarkTypeEnum_Imei V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkMarkTypeEnum = "imei"
)

type V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMark struct {
	CheckStatus V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkCheckStatusEnum `json:"check_status"` // 检查状态： - `processing`——正在检查中； - `failed`——系统未能成功处理请求； - `passed`——订单已准备好进行备货。
	ErrorCodes []string `json:"error_codes"` // 检查控制识别码及其他标识时出现的错误。
	Mark string `json:"mark"` // 标志代码的值。
	MarkType V5FbsPostingProductExemplarStatusV5ResponseProductExemplarMarkMarkTypeEnum `json:"mark_type"` // 标志代码类型： - `mandatory_mark` — “诚实标志”（Chestny ZNAK）强制性标志； - `jw_uin` — 珠宝制品的唯 一 识别编号； - `imei` — 移动设备 IMEI。
}
...
// 标志代码类型：
type ExemplarsMarksMarkTypeEnum string
const (
	ExemplarsMarksMarkTypeEnum_MandatoryMark ExemplarsMarksMarkTypeEnum = "mandatory_mark"
	ExemplarsMarksMarkTypeEnum_JwUin ExemplarsMarksMarkTypeEnum = "jw_uin"
	ExemplarsMarksMarkTypeEnum_Imei ExemplarsMarksMarkTypeEnum = "imei"
)

type ExemplarsMarks struct {
	Mark string `json:"mark"` // 标志代码的值。
	MarkType ExemplarsMarksMarkTypeEnum `json:"mark_type"` // 标志代码类型： - `mandatory_mark` — “诚实标志”（Chestny ZNAK）强制性标志； - `jw_uin` — 珠宝制品的唯 一 识别编号； - `imei` — 移动设备 IMEI。
}
...
type ProductV1ProductVisibilitySetRequest struct {
	ItemPlacement []ProductV1ProductVisibilitySetRequestItemPlacement `json:"item_placement"` // 商品可见性信息。
}
...
// 所有样件和备货可用性的验证状态：
type V5FbsPostingProductExemplarStatusV5ResponseStatusEnum string
const (
	V5FbsPostingProductExemplarStatusV5ResponseStatusEnum_ShipAvailable V5FbsPostingProductExemplarStatusV5ResponseStatusEnum = "ship_available"
	V5FbsPostingProductExemplarStatusV5ResponseStatusEnum_ShipNotAvailable V5FbsPostingProductExemplarStatusV5ResponseStatusEnum = "ship_not_available"
	V5FbsPostingProductExemplarStatusV5ResponseStatusEnum_ValidationInProcess V5FbsPostingProductExemplarStatusV5ResponseStatusEnum = "validation_in_process"
	V5FbsPostingProductExemplarStatusV5ResponseStatusEnum_UpdateAvailable V5FbsPostingProductExemplarStatusV5ResponseStatusEnum = "update_available"
	V5FbsPostingProductExemplarStatusV5ResponseStatusEnum_UpdateNotAvailable V5FbsPostingProductExemplarStatusV5ResponseStatusEnum = "update_not_available"
)
...
type V5FbsPostingProductExemplarStatusV5Response struct {
	...
	Status V5FbsPostingProductExemplarStatusV5ResponseStatusEnum `json:"status"` // 所有样件和备货可用性的验证状态： - `ship_available`——可以备货， - `ship_not_available`——无法备货， - `validation_in_process`——样件正在验证中， - `update_a...
}
...
// 标志代码类型：
type ExemplarMarkMarkTypeEnum string
const (
	ExemplarMarkMarkTypeEnum_MandatoryMark ExemplarMarkMarkTypeEnum = "mandatory_mark"
	ExemplarMarkMarkTypeEnum_JwUin ExemplarMarkMarkTypeEnum = "jw_uin"
	ExemplarMarkMarkTypeEnum_Imei ExemplarMarkMarkTypeEnum = "imei"
)

type ExemplarMark struct {
	Mark string `json:"mark"` // 标志代码的值。
	MarkType ExemplarMarkMarkTypeEnum `json:"mark_type"` // 标志代码类型： - `mandatory_mark` — “诚实标志”（Chestny ZNAK）强制性标志； - `jw_uin` — 珠宝制品的唯 一 识别编号； - `imei` — 移动设备 IMEI。
}
...
type FinanceV1GetFinanceAccrualByDayResponseAccrualItemFees struct {
	Fees []FinanceV1GetFinanceAccrualByDayResponseAccrualItemFeesItemFee `json:"fees"` // 某一商品的应计项目。
}
...
// 报告期结束日期，格式为 `YYYY-MM-DD`
type V1GetFinanceBalanceV1RequestDateToEnum string
const (
	V1GetFinanceBalanceV1RequestDateToEnum_YYYYMMDD V1GetFinanceBalanceV1RequestDateToEnum = "YYYY-MM-DD"
	V1GetFinanceBalanceV1RequestDateToEnum_DateFrom V1GetFinanceBalanceV1RequestDateToEnum = "date_from"
	V1GetFinanceBalanceV1RequestDateToEnum_DateTo V1GetFinanceBalanceV1RequestDateToEnum = "date_to"
)

type V1GetFinanceBalanceV1Request struct {
	DateFrom string `json:"date_from"` // 报告期开始日期，格式为 `YYYY-MM-DD`。
	DateTo V1GetFinanceBalanceV1RequestDateToEnum `json:"date_to"` // 报告期结束日期，格式为 `YYYY-MM-DD`。`date_from` 与 `date_to` 之间的最⻓间隔为30 天。
}
...
type FinanceV1GetFinanceAccrualTypesResponse struct {
	AccrualTypes []FinanceV1GetFinanceAccrualTypesResponseAccrualType `json:"accrual_types"` // 应计项目相关信息。
}
