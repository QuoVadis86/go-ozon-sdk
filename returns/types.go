...
type V2Product struct {
	...
	CurrencyCode enum.CurrencyCode `json:"currency_code"` // 您的价格所使用的货币。与您在个人中心中设置的货币相匹配。 可能的值: - `RUB` — 俄罗斯卢布, - `BYN` — 白俄罗斯卢布, - `KZT` — 坚戈, - `EUR` — 欧元, - `USD` — 美元, - `CNY` ...
...
const (
	V2CancellationInitiatorOzon     V2CancellationInitiator = "OZON"
	V2CancellationInitiatorSeller   V2CancellationInitiator = "SELLER"
	V2CancellationInitiatorClient   V2CancellationInitiator = "CLIENT"
	V2CancellationInitiatorSystem   V2CancellationInitiator = "SYSTEM"
	V2CancellationInitiatorDelivery V2CancellationInitiator = "DELIVERY"
)
...
const (
	V2CancellationStateONApproval V2CancellationState = "ON_APPROVAL"
	V2CancellationStateApproved   V2CancellationState = "APPROVED"
	V2CancellationStateRejected   V2CancellationState = "REJECTED"
)
...
const (
	V2CancellationStateEnumFiltersALL        V2CancellationStateEnumFilters = "ALL"
	V2CancellationStateEnumFiltersONApproval V2CancellationStateEnumFilters = "ON_APPROVAL"
	V2CancellationStateEnumFiltersApproved   V2CancellationStateEnumFilters = "APPROVED"
	V2CancellationStateEnumFiltersRejected   V2CancellationStateEnumFilters = "REJECTED"
)
