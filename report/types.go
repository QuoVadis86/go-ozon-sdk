...
const (
	ListRequestReportTypeALL                       ListRequestReportType = "ALL"                          // 所有报告
	ListRequestReportTypeSellerProducts            ListRequestReportType = "SELLER_PRODUCTS"              // 商品报告
	ListRequestReportTypeSellerStock               ListRequestReportType = "SELLER_STOCK"                 // 商品库存报告
	ListRequestReportTypeSellerReturns             ListRequestReportType = "SELLER_RETURNS"               // 退货报告
	ListRequestReportTypeSellerPostings            ListRequestReportType = "SELLER_POSTINGS"              // 发货报告
	ListRequestReportTypeSellerDiscounted          ListRequestReportType = "SELLER_DISCOUNTED"            // 减价商品报告
	ListRequestReportTypeMutualSettlement          ListRequestReportType = "MUTUAL_SETTLEMENT"            // 结算报告
	ListRequestReportTypeDocumentB2BSales          ListRequestReportType = "DOCUMENT_B2B_SALES"           // 面向法人客户的销售报告
	ListRequestReportTypeCompensationReport        ListRequestReportType = "COMPENSATION_REPORT"          // 赔偿报告
	ListRequestReportTypeDecompensationReport      ListRequestReportType = "DECOMPENSATION_REPORT"        // 赔偿返还报告
	ListRequestReportTypeMarkedProductsSales       ListRequestReportType = "MARKED_PRODUCTS_SALES"        // 标签销售报告
	ListRequestReportTypeSellerPlacementBYProducts ListRequestReportType = "SELLER_PLACEMENT_BY_PRODUCTS" // 按商品维度的存储服务费用报告
	ListRequestReportTypeSellerPlacementBYSupplies ListRequestReportType = "SELLER_PLACEMENT_BY_SUPPLIES" // 按交货维度的存储服务费用报告
)
...
const (
	NameMarketplaceServiceItemElectronicServiceStencil            Name = "MarketplaceServiceItemElectronicServiceStencil"            // “模板”服务
	NameMarketplaceServiceItemElectronicServicesPromotionInSearch Name = "MarketplaceServiceItemElectronicServicesPromotionInSearch" // “搜索结果推广”服务
	NameMarketplaceServiceItemElectronicServicesBrandShelf        Name = "MarketplaceServiceItemElectronicServicesBrandShelf"        // “品牌货架”服务
	NameMarketplaceServiceBrandPromotion                          Name = "MarketplaceServiceBrandPromotion"                          // 和 `MarketplaceServiceBrandCommission` — “品牌推广”服务
	NameMarketplaceServiceItemMarketingServices                   Name = "MarketplaceServiceItemMarketingServices"                   // 营销服务
	NameMarketplaceServiceItemOtherMarketAndTechService           Name = "MarketplaceServiceItemOtherMarketAndTechService"           // 其他销售和技术服务
	NameMarketplaceReturnStorageServiceAtThePickupPointFbsItem    Name = "MarketplaceReturnStorageServiceAtThePickupPointFbsItem"    // 短期FBS退货安置
	NameMarketplaceSaleReviewsItem                                Name = "MarketplaceSaleReviewsItem"                                // 在平台上获得评论
	NameMarketplaceServicePremiumCashbackIndividualPoints         Name = "MarketplaceServicePremiumCashbackIndividualPoints"         // 推广服务“卖家奖励”
	NameOperationMarketplaceServiceStorage                        Name = "OperationMarketplaceServiceStorage"                        // 商品放置服务
	NameMarketplaceServiceStockDisposal                           Name = "MarketplaceServiceStockDisposal"                           // 从库存中处置
	NameMarketplaceReturnDisposalServiceFbsItem                   Name = "MarketplaceReturnDisposalServiceFbsItem"                   // FBS处置
	NameMarketplaceServiceItemFlexiblePaymentSchedule             Name = "MarketplaceServiceItemFlexiblePaymentSchedule"             // “灵活付款计划”服务
	NameMarketplaceServiceProcessingSpoilage                      Name = "MarketplaceServiceProcessingSpoilage"                      // 残次品处理
	NameMarketplaceServiceProcessingIdentifiedSurplus             Name = "MarketplaceServiceProcessingIdentifiedSurplus"             // 处理确定的盈余
	NameMarketplaceServiceProcessingIdentifiedDiscrepancies       Name = "MarketplaceServiceProcessingIdentifiedDiscrepancies"       // 预定放置在仓库中的位置
	NameMarketplaceServiceItemInternetSiteAdvertising             Name = "MarketplaceServiceItemInternetSiteAdvertising"             // Ozon网站上的广告
	NameMarketplaceServiceItemSubscribtionPremium                 Name = "MarketplaceServiceItemSubscribtionPremium"                 // 高级订阅
	NameMarketplaceAgencyFeeAggregator3PLGlobalItem               Name = "MarketplaceAgencyFeeAggregator3PLGlobalItem"               // Ozon代理费用
)
