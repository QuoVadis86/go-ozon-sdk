...
// 排序参数
type AnalyticsFilterKeyEnum string
const (
	AnalyticsFilterKeyEnum_Dimension AnalyticsFilterKeyEnum = "dimension"
	AnalyticsFilterKeyEnum_Metric AnalyticsFilterKeyEnum = "metric"
	AnalyticsFilterKeyEnum_Brand AnalyticsFilterKeyEnum = "brand"
)

type AnalyticsFilter struct {
	Key AnalyticsFilterKeyEnum `json:"key"` // 排序参数。 可以传递`dimension` 和 `metric`中的任何属性, `brand`除外。
	Op FilterOp `json:"op"`
...
// 报告中的分组数据
type AnalyticsAnalyticsGetDataRequestDimensionEnum string
const (
	AnalyticsAnalyticsGetDataRequestDimensionEnum_UnknownDimension AnalyticsAnalyticsGetDataRequestDimensionEnum = "unknownDimension"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_Sku AnalyticsAnalyticsGetDataRequestDimensionEnum = "sku"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_Spu AnalyticsAnalyticsGetDataRequestDimensionEnum = "spu"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_Day AnalyticsAnalyticsGetDataRequestDimensionEnum = "day"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_Week AnalyticsAnalyticsGetDataRequestDimensionEnum = "week"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_Month AnalyticsAnalyticsGetDataRequestDimensionEnum = "month"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_Year AnalyticsAnalyticsGetDataRequestDimensionEnum = "year"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_Category1 AnalyticsAnalyticsGetDataRequestDimensionEnum = "category1"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_Category2 AnalyticsAnalyticsGetDataRequestDimensionEnum = "category2"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_Brand AnalyticsAnalyticsGetDataRequestDimensionEnum = "brand"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_ModelID AnalyticsAnalyticsGetDataRequestDimensionEnum = "modelID"
	AnalyticsAnalyticsGetDataRequestDimensionEnum_DescriptionType AnalyticsAnalyticsGetDataRequestDimensionEnum = "descriptionType"
)

// 最多指定14个指标
type AnalyticsAnalyticsGetDataRequestMetricsEnum string
const (
	AnalyticsAnalyticsGetDataRequestMetricsEnum_InvalidArgument AnalyticsAnalyticsGetDataRequestMetricsEnum = "InvalidArgument"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_Revenue AnalyticsAnalyticsGetDataRequestMetricsEnum = "revenue"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_OrderedUnits AnalyticsAnalyticsGetDataRequestMetricsEnum = "ordered_units"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_UnknownMetric AnalyticsAnalyticsGetDataRequestMetricsEnum = "unknown_metric"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_HitsViewSearch AnalyticsAnalyticsGetDataRequestMetricsEnum = "hits_view_search"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_HitsViewPdp AnalyticsAnalyticsGetDataRequestMetricsEnum = "hits_view_pdp"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_HitsView AnalyticsAnalyticsGetDataRequestMetricsEnum = "hits_view"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_HitsTocartSearch AnalyticsAnalyticsGetDataRequestMetricsEnum = "hits_tocart_search"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_HitsTocartPdp AnalyticsAnalyticsGetDataRequestMetricsEnum = "hits_tocart_pdp"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_HitsTocart AnalyticsAnalyticsGetDataRequestMetricsEnum = "hits_tocart"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_SessionViewSearch AnalyticsAnalyticsGetDataRequestMetricsEnum = "session_view_search"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_SessionViewPdp AnalyticsAnalyticsGetDataRequestMetricsEnum = "session_view_pdp"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_SessionView AnalyticsAnalyticsGetDataRequestMetricsEnum = "session_view"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_ConvTocartSearch AnalyticsAnalyticsGetDataRequestMetricsEnum = "conv_tocart_search"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_ConvTocartPdp AnalyticsAnalyticsGetDataRequestMetricsEnum = "conv_tocart_pdp"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_ConvTocart AnalyticsAnalyticsGetDataRequestMetricsEnum = "conv_tocart"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_Returns AnalyticsAnalyticsGetDataRequestMetricsEnum = "returns"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_Cancellations AnalyticsAnalyticsGetDataRequestMetricsEnum = "cancellations"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_DeliveredUnits AnalyticsAnalyticsGetDataRequestMetricsEnum = "delivered_units"
	AnalyticsAnalyticsGetDataRequestMetricsEnum_PositionCategory AnalyticsAnalyticsGetDataRequestMetricsEnum = "position_category"
)
