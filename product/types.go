...
type V4GetUploadQuotaResponseOperationLimitsLimitType string

const (
	V4GetUploadQuotaResponseOperationLimitsLimitTypeUnspecified        V4GetUploadQuotaResponseOperationLimitsLimitType = "UNSPECIFIED"
	V4GetUploadQuotaResponseOperationLimitsLimitTypeRateLimitPERMinute V4GetUploadQuotaResponseOperationLimitsLimitType = "RATE_LIMIT_PER_MINUTE"
)

// 商品操作的可用限额。
type V4GetUploadQuotaResponseOperationLimits struct {
	LimitType V4GetUploadQuotaResponseOperationLimitsLimitType `json:"limit_type"`
...
const (
	ErrorErrorLevelErrorLevelUnspecified ErrorErrorLevel = "ERROR_LEVEL_UNSPECIFIED"
	ErrorErrorLevelErrorLevelError       ErrorErrorLevel = "ERROR_LEVEL_ERROR"
	ErrorErrorLevelErrorLevelWarning     ErrorErrorLevel = "ERROR_LEVEL_WARNING"
	ErrorErrorLevelErrorLevelInternal    ErrorErrorLevel = "ERROR_LEVEL_INTERNAL"
)
...
const (
	V3GetProductInfoListResponsePromotionTypeUnspecified  V3GetProductInfoListResponsePromotionType = "UNSPECIFIED"
	V3GetProductInfoListResponsePromotionTypeReviewsPromo V3GetProductInfoListResponsePromotionType = "REVIEWS_PROMO"
)
...
const (
	SourceShipmentTypeShipmentTypeUnspecified SourceShipmentType = "SHIPMENT_TYPE_UNSPECIFIED"
	SourceShipmentTypeShipmentTypeGeneral     SourceShipmentType = "SHIPMENT_TYPE_GENERAL"
	SourceShipmentTypeShipmentTypeBOX         SourceShipmentType = "SHIPMENT_TYPE_BOX"
	SourceShipmentTypeShipmentTypePallet      SourceShipmentType = "SHIPMENT_TYPE_PALLET"
)
...
const (
	PriceIndexesColorIndexColorIndexUnspecified  PriceIndexesColorIndex = "COLOR_INDEX_UNSPECIFIED"
	PriceIndexesColorIndexColorIndexWithoutIndex PriceIndexesColorIndex = "COLOR_INDEX_WITHOUT_INDEX"
	PriceIndexesColorIndexColorIndexSuper        PriceIndexesColorIndex = "COLOR_INDEX_SUPER"
	PriceIndexesColorIndexColorIndexGreen        PriceIndexesColorIndex = "COLOR_INDEX_GREEN"
	PriceIndexesColorIndexColorIndexYellow       PriceIndexesColorIndex = "COLOR_INDEX_YELLOW"
	PriceIndexesColorIndexColorIndexRED          PriceIndexesColorIndex = "COLOR_INDEX_RED"
)
...
const (
	V2GetProductListRequestFilterFilterVisibilityALL                    V2GetProductListRequestFilterFilterVisibility = "ALL"
	V2GetProductListRequestFilterFilterVisibilityVisible                V2GetProductListRequestFilterFilterVisibility = "VISIBLE"
	V2GetProductListRequestFilterFilterVisibilityInvisible              V2GetProductListRequestFilterFilterVisibility = "INVISIBLE"
	V2GetProductListRequestFilterFilterVisibilityEmptyStock             V2GetProductListRequestFilterFilterVisibility = "EMPTY_STOCK"
	V2GetProductListRequestFilterFilterVisibilityNOTModerated           V2GetProductListRequestFilterFilterVisibility = "NOT_MODERATED"
	V2GetProductListRequestFilterFilterVisibilityModerated              V2GetProductListRequestFilterFilterVisibility = "MODERATED"
	V2GetProductListRequestFilterFilterVisibilityDisabled               V2GetProductListRequestFilterFilterVisibility = "DISABLED"
	V2GetProductListRequestFilterFilterVisibilityStateFailed            V2GetProductListRequestFilterFilterVisibility = "STATE_FAILED"
	V2GetProductListRequestFilterFilterVisibilityReadyTOSupply          V2GetProductListRequestFilterFilterVisibility = "READY_TO_SUPPLY"
	V2GetProductListRequestFilterFilterVisibilityValidationStatePending V2GetProductListRequestFilterFilterVisibility = "VALIDATION_STATE_PENDING"
	V2GetProductListRequestFilterFilterVisibilityValidationStateFail    V2GetProductListRequestFilterFilterVisibility = "VALIDATION_STATE_FAIL"
	V2GetProductListRequestFilterFilterVisibilityValidationStateSuccess V2GetProductListRequestFilterFilterVisibility = "VALIDATION_STATE_SUCCESS"
	V2GetProductListRequestFilterFilterVisibilityTOSupply               V2GetProductListRequestFilterFilterVisibility = "TO_SUPPLY"
	V2GetProductListRequestFilterFilterVisibilityINSale                 V2GetProductListRequestFilterFilterVisibility = "IN_SALE"
	V2GetProductListRequestFilterFilterVisibilityRemovedFromSale        V2GetProductListRequestFilterFilterVisibility = "REMOVED_FROM_SALE"
	V2GetProductListRequestFilterFilterVisibilityBanned                 V2GetProductListRequestFilterFilterVisibility = "BANNED"
	V2GetProductListRequestFilterFilterVisibilityOverpriced             V2GetProductListRequestFilterFilterVisibility = "OVERPRICED"
	V2GetProductListRequestFilterFilterVisibilityCriticallyOverpriced   V2GetProductListRequestFilterFilterVisibility = "CRITICALLY_OVERPRICED"
	V2GetProductListRequestFilterFilterVisibilityEmptyBarcode           V2GetProductListRequestFilterFilterVisibility = "EMPTY_BARCODE"
	V2GetProductListRequestFilterFilterVisibilityBarcodeExists          V2GetProductListRequestFilterFilterVisibility = "BARCODE_EXISTS"
	V2GetProductListRequestFilterFilterVisibilityQuarantine             V2GetProductListRequestFilterFilterVisibility = "QUARANTINE"
	V2GetProductListRequestFilterFilterVisibilityArchived               V2GetProductListRequestFilterFilterVisibility = "ARCHIVED"
	V2GetProductListRequestFilterFilterVisibilityOverpricedWithStock    V2GetProductListRequestFilterFilterVisibility = "OVERPRICED_WITH_STOCK"
	V2GetProductListRequestFilterFilterVisibilityPartialApproved        V2GetProductListRequestFilterFilterVisibility = "PARTIAL_APPROVED"
	V2GetProductListRequestFilterFilterVisibilityImageAbsent            V2GetProductListRequestFilterFilterVisibility = "IMAGE_ABSENT"
	V2GetProductListRequestFilterFilterVisibilityModerationBlock        V2GetProductListRequestFilterFilterVisibility = "MODERATION_BLOCK"
	V2GetProductListRequestFilterFilterVisibilityAutoArchived           V2GetProductListRequestFilterFilterVisibility = "AUTO_ARCHIVED"
	V2GetProductListRequestFilterFilterVisibilityManualArchived         V2GetProductListRequestFilterFilterVisibility = "MANUAL_ARCHIVED"
	V2GetProductListRequestFilterFilterVisibilitySeasonalAutoArchived   V2GetProductListRequestFilterFilterVisibility = "SEASONAL_AUTO_ARCHIVED"
	V2GetProductListRequestFilterFilterVisibilityVisibleWithFBOStock    V2GetProductListRequestFilterFilterVisibility = "VISIBLE_WITH_FBO_STOCK"
)
...
type V4GetProductAttributesV4Request struct {
	...
	Limit   int32    `json:"limit"`    // K每页的值的数量。
...
type V4GetProductAttributesV4ResponseResult struct {
	...
	DimensionUnit          enum.DimensionUnit                        `json:"dimension_unit"`           // 尺寸的测量单位。 - `mm` —— 毫米， - `cm` —— 厘米， - `in` —— 英寸。
...
type ImportProductsRequestPdf struct {
...
type ImportProductsBySKURequestItem struct {
	...
	Vat          enum.Vat          `json:"vat"`           // 商品增值税税率： - `0` — 免除增值税, - `0.05` — 5%, - `0.07` — 7%, - `0.1` — 10%, - `0.2` — 20%, - `0.22` — 22%。 传递当前有效的出价值。
	CurrencyCode enum.CurrencyCode `json:"currency_code"` // 价格显示的货币。 传输值必须与个人中心设置中所设置的货币相匹配。 默认情况下，显示`RUB` — 俄罗斯卢布。 例如，如果您设人民币为结算货币，请赋值`CNY`，否则将返回错误。 可能的值： - `RUB` — 俄罗斯卢布, - `BYN`...
...
const (
	V3GetProductListRequestFilterFilterVisibilityALL                    V3GetProductListRequestFilterFilterVisibility = "ALL"
	V3GetProductListRequestFilterFilterVisibilityVisible                V3GetProductListRequestFilterFilterVisibility = "VISIBLE"
	V3GetProductListRequestFilterFilterVisibilityInvisible              V3GetProductListRequestFilterFilterVisibility = "INVISIBLE"
	V3GetProductListRequestFilterFilterVisibilityEmptyStock             V3GetProductListRequestFilterFilterVisibility = "EMPTY_STOCK"
	V3GetProductListRequestFilterFilterVisibilityNOTModerated           V3GetProductListRequestFilterFilterVisibility = "NOT_MODERATED"
	V3GetProductListRequestFilterFilterVisibilityModerated              V3GetProductListRequestFilterFilterVisibility = "MODERATED"
	V3GetProductListRequestFilterFilterVisibilityDisabled               V3GetProductListRequestFilterFilterVisibility = "DISABLED"
	V3GetProductListRequestFilterFilterVisibilityStateFailed            V3GetProductListRequestFilterFilterVisibility = "STATE_FAILED"
	V3GetProductListRequestFilterFilterVisibilityReadyTOSupply          V3GetProductListRequestFilterFilterVisibility = "READY_TO_SUPPLY"
	V3GetProductListRequestFilterFilterVisibilityValidationStatePending V3GetProductListRequestFilterFilterVisibility = "VALIDATION_STATE_PENDING"
	V3GetProductListRequestFilterFilterVisibilityValidationStateFail    V3GetProductListRequestFilterFilterVisibility = "VALIDATION_STATE_FAIL"
	V3GetProductListRequestFilterFilterVisibilityValidationStateSuccess V3GetProductListRequestFilterFilterVisibility = "VALIDATION_STATE_SUCCESS"
	V3GetProductListRequestFilterFilterVisibilityTOSupply               V3GetProductListRequestFilterFilterVisibility = "TO_SUPPLY"
	V3GetProductListRequestFilterFilterVisibilityINSale                 V3GetProductListRequestFilterFilterVisibility = "IN_SALE"
	V3GetProductListRequestFilterFilterVisibilityRemovedFromSale        V3GetProductListRequestFilterFilterVisibility = "REMOVED_FROM_SALE"
	V3GetProductListRequestFilterFilterVisibilityOverpriced             V3GetProductListRequestFilterFilterVisibility = "OVERPRICED"
	V3GetProductListRequestFilterFilterVisibilityCriticallyOverpriced   V3GetProductListRequestFilterFilterVisibility = "CRITICALLY_OVERPRICED"
	V3GetProductListRequestFilterFilterVisibilityEmptyBarcode           V3GetProductListRequestFilterFilterVisibility = "EMPTY_BARCODE"
	V3GetProductListRequestFilterFilterVisibilityBarcodeExists          V3GetProductListRequestFilterFilterVisibility = "BARCODE_EXISTS"
	V3GetProductListRequestFilterFilterVisibilityQuarantine             V3GetProductListRequestFilterFilterVisibility = "QUARANTINE"
	V3GetProductListRequestFilterFilterVisibilityArchived               V3GetProductListRequestFilterFilterVisibility = "ARCHIVED"
	V3GetProductListRequestFilterFilterVisibilityOverpricedWithStock    V3GetProductListRequestFilterFilterVisibility = "OVERPRICED_WITH_STOCK"
	V3GetProductListRequestFilterFilterVisibilityPartialApproved        V3GetProductListRequestFilterFilterVisibility = "PARTIAL_APPROVED"
	V3GetProductListRequestFilterFilterVisibilityAutoArchived           V3GetProductListRequestFilterFilterVisibility = "AUTO_ARCHIVED"
	V3GetProductListRequestFilterFilterVisibilityManualArchived         V3GetProductListRequestFilterFilterVisibility = "MANUAL_ARCHIVED"
	V3GetProductListRequestFilterFilterVisibilitySeasonalAutoArchived   V3GetProductListRequestFilterFilterVisibility = "SEASONAL_AUTO_ARCHIVED"
	V3GetProductListRequestFilterFilterVisibilityVisibleWithFBOStock    V3GetProductListRequestFilterFilterVisibility = "VISIBLE_WITH_FBO_STOCK"
)
...
const (
	V2ServiceTypeISCodeService   V2ServiceType = "IS_CODE_SERVICE"
	V2ServiceTypeISNOCodeService V2ServiceType = "IS_NO_CODE_SERVICE"
)
...
type V3GetProductAttributesV3ResponseResult struct {
	...
	Barcode               string                                           `json:"barcode"`                 // 条形码。
	DescriptionCategoryID int64                                            `json:"description_category_id"` // 类别ID。 请将其与以下方法结合使用：[/v1/description-category/attribute](#operation/DescriptionCategoryAPI_GetAttributes) 和 [/v1/descript...
...
type V3ImportProductsRequestItem struct {
	...
	PDFList                  []ImportProductsRequestPdf                `json:"pdf_list"`           // PDF-文件清单。
	Price                    string                                    `json:"price"`              // 商品价格，包括折扣，显示在商品卡上。 如果商品没有折扣，请指定 此参数中 `old_price` 的值。
	WeightUnit               enum.WeightUnit                           `json:"weight_unit"`        // 测重单位： - `g` — 克, - `kg` — 公斤, - `lb` — 磅。
	PrimaryImage             string                                    `json:"primary_image"`      // 链接到商品主图。
	ColorImage               string                                    `json:"color_image"`        // 营销色彩。 格式：公共云存储中图像链接的URL。 链接的图像格式为JPG。
	DimensionUnit            enum.DimensionUnit                        `json:"dimension_unit"`     // 尺寸测量单位: - `mm` — 毫米, - `cm` — 厘米, - `in` — 英寸。
