...
// 图片上传状态
type ProductProductInfoPicturesResponsePictureStateEnum string
const (
	ProductProductInfoPicturesResponsePictureStateEnum_Imported ProductProductInfoPicturesResponsePictureStateEnum = "imported"
	ProductProductInfoPicturesResponsePictureStateEnum_Uploaded ProductProductInfoPicturesResponsePictureStateEnum = "uploaded"
	ProductProductInfoPicturesResponsePictureStateEnum_Pending ProductProductInfoPicturesResponsePictureStateEnum = "pending"
)

type ProductProductInfoPicturesResponsePicture struct {
	ProductID int64 `json:"product_id"` // Ozon系统中商品的标识符 — `product_id`。
	State ProductProductInfoPicturesResponsePictureStateEnum `json:"state"` // 图片上传状态。 如果方法[/v1/product/pictures/import](#operation/ProductAPI_ProductImportPictures)被使用，方法的响应将总是`imported` —— 图像未被处理。 ...
...
// 销售模式：
type GetProductInfoListResponseSourceSourceEnum string
const (
	GetProductInfoListResponseSourceSourceEnum_SDS GetProductInfoListResponseSourceSourceEnum = "SDS"
	GetProductInfoListResponseSourceSourceEnum_FBO GetProductInfoListResponseSourceSourceEnum = "FBO"
	GetProductInfoListResponseSourceSourceEnum_FBS GetProductInfoListResponseSourceSourceEnum = "FBS"
)
...
type GetProductInfoListResponseSource struct {
	...
	Source GetProductInfoListResponseSourceSourceEnum `json:"source"` // 销售模式： - `SDS` — 适用于 FBO 和 FBS，且 SKU 相同； - `FBO`; - `FBS`。
...
// 商品创建或更新状态
type GetImportProductsInfoResponseResultItemStatusEnum string
const (
	GetImportProductsInfoResponseResultItemStatusEnum_Pending GetImportProductsInfoResponseResultItemStatusEnum = "pending"
	GetImportProductsInfoResponseResultItemStatusEnum_Imported GetImportProductsInfoResponseResultItemStatusEnum = "imported"
	GetImportProductsInfoResponseResultItemStatusEnum_Failed GetImportProductsInfoResponseResultItemStatusEnum = "failed"
	GetImportProductsInfoResponseResultItemStatusEnum_Skipped GetImportProductsInfoResponseResultItemStatusEnum = "skipped"
)

type GetImportProductsInfoResponseResultItem struct {
	OfferID string `json:"offer_id"` // 在卖方系统中的商品ID是货号。字段数值中行的最大长度为50个字符。
	ProductID int64 `json:"product_id"` // Ozon系统中商品的标识符 — `product_id`。
	Status GetImportProductsInfoResponseResultItemStatusEnum `json:"status"` // 商品创建或更新状态。 商品信息在队列中处理。 可能的参数值: - `pending` — 商品等待排队处理; - `imported` — 商品已成功加载； - `failed` — 商品加载错误； - `skipped` — 商品未更新，...
...
// 尺寸的测量单位
type Productv3GetProductAttributesV3ResponseResultDimensionUnitEnum string
const (
	Productv3GetProductAttributesV3ResponseResultDimensionUnitEnum_Mm Productv3GetProductAttributesV3ResponseResultDimensionUnitEnum = "mm"
	Productv3GetProductAttributesV3ResponseResultDimensionUnitEnum_Cm Productv3GetProductAttributesV3ResponseResultDimensionUnitEnum = "cm"
	Productv3GetProductAttributesV3ResponseResultDimensionUnitEnum_In Productv3GetProductAttributesV3ResponseResultDimensionUnitEnum = "in"
)
...
type Productv3GetProductAttributesV3ResponseResult struct {
	...
	DimensionUnit Productv3GetProductAttributesV3ResponseResultDimensionUnitEnum `json:"dimension_unit"` // 尺寸的测量单位。 - `mm` —— 毫米， - `cm` —— 厘米， - `in` —— 英寸。
...
// 促销活动操作属性：
type ImportProductRequestPromotionOperationEnum string
const (
	ImportProductRequestPromotionOperationEnum_ENABLE ImportProductRequestPromotionOperationEnum = "ENABLE"
	ImportProductRequestPromotionOperationEnum_DISABLE ImportProductRequestPromotionOperationEnum = "DISABLE"
	ImportProductRequestPromotionOperationEnum_UNKNOWN ImportProductRequestPromotionOperationEnum = "UNKNOWN"
)

type ImportProductRequestPromotion struct {
	Operation ImportProductRequestPromotionOperationEnum `json:"operation"` // 促销活动操作属性： - `ENABLE` — 启用， - `DISABLE` — 禁用， - `UNKNOWN` — 保持默认，不做修改。
...
// 尺寸测量单位:
type V3ImportProductsRequestItemDimensionUnitEnum string
const (
	V3ImportProductsRequestItemDimensionUnitEnum_Mm V3ImportProductsRequestItemDimensionUnitEnum = "mm"
	V3ImportProductsRequestItemDimensionUnitEnum_Cm V3ImportProductsRequestItemDimensionUnitEnum = "cm"
	V3ImportProductsRequestItemDimensionUnitEnum_In V3ImportProductsRequestItemDimensionUnitEnum = "in"
)

// 价格显示的货币
type V3ImportProductsRequestItemCurrencyCodeEnum string
const (
	V3ImportProductsRequestItemCurrencyCodeEnum_RUB V3ImportProductsRequestItemCurrencyCodeEnum = "RUB"
	V3ImportProductsRequestItemCurrencyCodeEnum_CNY V3ImportProductsRequestItemCurrencyCodeEnum = "CNY"
	V3ImportProductsRequestItemCurrencyCodeEnum_BYN V3ImportProductsRequestItemCurrencyCodeEnum = "BYN"
	V3ImportProductsRequestItemCurrencyCodeEnum_KZT V3ImportProductsRequestItemCurrencyCodeEnum = "KZT"
	V3ImportProductsRequestItemCurrencyCodeEnum_EUR V3ImportProductsRequestItemCurrencyCodeEnum = "EUR"
	V3ImportProductsRequestItemCurrencyCodeEnum_USD V3ImportProductsRequestItemCurrencyCodeEnum = "USD"
)

// 折扣前的价格（将在产品卡上划掉）
type V3ImportProductsRequestItemOldPriceEnum string
const (
	V3ImportProductsRequestItemOldPriceEnum_OldPrice V3ImportProductsRequestItemOldPriceEnum = "old_price"
	V3ImportProductsRequestItemOldPriceEnum_Price V3ImportProductsRequestItemOldPriceEnum = "price"
)

// 商品增值税税率：
type V3ImportProductsRequestItemVatEnum string
const (
	V3ImportProductsRequestItemVatEnum_V005 V3ImportProductsRequestItemVatEnum = "0.05"
	V3ImportProductsRequestItemVatEnum_V007 V3ImportProductsRequestItemVatEnum = "0.07"
	V3ImportProductsRequestItemVatEnum_V01 V3ImportProductsRequestItemVatEnum = "0.1"
	V3ImportProductsRequestItemVatEnum_V02 V3ImportProductsRequestItemVatEnum = "0.2"
	V3ImportProductsRequestItemVatEnum_V022 V3ImportProductsRequestItemVatEnum = "0.22"
)

// 测重单位：
type V3ImportProductsRequestItemWeightUnitEnum string
const (
	V3ImportProductsRequestItemWeightUnitEnum_G V3ImportProductsRequestItemWeightUnitEnum = "g"
	V3ImportProductsRequestItemWeightUnitEnum_Kg V3ImportProductsRequestItemWeightUnitEnum = "kg"
	V3ImportProductsRequestItemWeightUnitEnum_Lb V3ImportProductsRequestItemWeightUnitEnum = "lb"
)

// 商品类型的标识符
type V3ImportProductsRequestItemTypeIDEnum string
const (
	V3ImportProductsRequestItemTypeIDEnum_TypeId V3ImportProductsRequestItemTypeIDEnum = "type_id"
	V3ImportProductsRequestItemTypeIDEnum_Attibutes V3ImportProductsRequestItemTypeIDEnum = "attibutes"
	V3ImportProductsRequestItemTypeIDEnum_Id8229 V3ImportProductsRequestItemTypeIDEnum = "id:8229"
)
...
type V3ImportProductsRequestItem struct {
	...
	CurrencyCode V3ImportProductsRequestItemCurrencyCodeEnum `json:"currency_code"` // 价格显示的货币。 传输值必须与个人中心设置中所设置的货币相匹配。 默认情况下，显示`RUB` — 俄罗斯卢布。 例如，如果您设人民币为结算货币，请赋值`CNY`，否则将返回错误。 可能的值： - `RUB` — 俄罗斯卢布, - `BYN`...
	...
	OldPrice V3ImportProductsRequestItemOldPriceEnum `json:"old_price"` // 折扣前的价格（将在产品卡上划掉）。 以卢布表示。分数分隔 符号 — 点, 在点之后最多两个字符。 如果您之前传递了 `old_price`, 那么在更新 `price` 时也请更新 `old_price`。
	Vat V3ImportProductsRequestItemVatEnum `json:"vat"` // 商品增值税税率： - `0` — 免除增值税, - `0.05` — 5%, - `0.07` — 7%, - `0.1` — 10%, - `0.2` — 20%, - `0.22` — 22%。 传递当前有效的出价值。
	Depth int32 `json:"depth"` // 包装厚度。
	Height int32 `json:"height"` // 包装高度。
	Weight int32 `json:"weight"` // 含包装的商品重量。 限值为1000公斤或其他换算值 计量单位。
	WeightUnit V3ImportProductsRequestItemWeightUnitEnum `json:"weight_unit"` // 测重单位： - `g` — 克, - `kg` — 公斤, - `lb` — 磅。
	Width int32 `json:"width"` // 包装宽度。
	...
	DimensionUnit V3ImportProductsRequestItemDimensionUnitEnum `json:"dimension_unit"` // 尺寸测量单位: - `mm` — 毫米, - `cm` — 厘米, - `in` — 英寸。
...
// 尺寸的测量单位
type Productv4GetProductAttributesV4ResponseResultDimensionUnitEnum string
const (
	Productv4GetProductAttributesV4ResponseResultDimensionUnitEnum_Mm Productv4GetProductAttributesV4ResponseResultDimensionUnitEnum = "mm"
	Productv4GetProductAttributesV4ResponseResultDimensionUnitEnum_Cm Productv4GetProductAttributesV4ResponseResultDimensionUnitEnum = "cm"
	Productv4GetProductAttributesV4ResponseResultDimensionUnitEnum_In Productv4GetProductAttributesV4ResponseResultDimensionUnitEnum = "in"
)

type Productv4GetProductAttributesV4ResponseResult struct {
	Depth int64 `json:"depth"` // 深度。
	DimensionUnit Productv4GetProductAttributesV4ResponseResultDimensionUnitEnum `json:"dimension_unit"` // 尺寸的测量单位。 - `mm` —— 毫米， - `cm` —— 厘米， - `in` —— 英寸。
...
// 商品增值税税率：
type ProductImportProductsBySKURequestItemVatEnum string
const (
	ProductImportProductsBySKURequestItemVatEnum_V005 ProductImportProductsBySKURequestItemVatEnum = "0.05"
	ProductImportProductsBySKURequestItemVatEnum_V007 ProductImportProductsBySKURequestItemVatEnum = "0.07"
	ProductImportProductsBySKURequestItemVatEnum_V01 ProductImportProductsBySKURequestItemVatEnum = "0.1"
	ProductImportProductsBySKURequestItemVatEnum_V02 ProductImportProductsBySKURequestItemVatEnum = "0.2"
	ProductImportProductsBySKURequestItemVatEnum_V022 ProductImportProductsBySKURequestItemVatEnum = "0.22"
)

// 价格显示的货币
type ProductImportProductsBySKURequestItemCurrencyCodeEnum string
const (
	ProductImportProductsBySKURequestItemCurrencyCodeEnum_RUB ProductImportProductsBySKURequestItemCurrencyCodeEnum = "RUB"
	ProductImportProductsBySKURequestItemCurrencyCodeEnum_CNY ProductImportProductsBySKURequestItemCurrencyCodeEnum = "CNY"
	ProductImportProductsBySKURequestItemCurrencyCodeEnum_BYN ProductImportProductsBySKURequestItemCurrencyCodeEnum = "BYN"
	ProductImportProductsBySKURequestItemCurrencyCodeEnum_KZT ProductImportProductsBySKURequestItemCurrencyCodeEnum = "KZT"
	ProductImportProductsBySKURequestItemCurrencyCodeEnum_EUR ProductImportProductsBySKURequestItemCurrencyCodeEnum = "EUR"
	ProductImportProductsBySKURequestItemCurrencyCodeEnum_USD ProductImportProductsBySKURequestItemCurrencyCodeEnum = "USD"
)

type ProductImportProductsBySKURequestItem struct {
	Vat ProductImportProductsBySKURequestItemVatEnum `json:"vat"` // 商品增值税税率： - `0` — 免除增值税, - `0.05` — 5%, - `0.07` — 7%, - `0.1` — 10%, - `0.2` — 20%, - `0.22` — 22%。 传递当前有效的出价值。
	CurrencyCode ProductImportProductsBySKURequestItemCurrencyCodeEnum `json:"currency_code"` // 价格显示的货币。 传输值必须与个人中心设置中所设置的货币相匹配。 默认情况下，显示`RUB` — 俄罗斯卢布。 例如，如果您设人民币为结算货币，请赋值`CNY`，否则将返回错误。 可能的值： - `RUB` — 俄罗斯卢布, - `BYN`...
...
// 排序方向：
type Productv4GetProductAttributesV4RequestSortDirEnum string
const (
	Productv4GetProductAttributesV4RequestSortDirEnum_Asc Productv4GetProductAttributesV4RequestSortDirEnum = "asc"
	Productv4GetProductAttributesV4RequestSortDirEnum_Desc Productv4GetProductAttributesV4RequestSortDirEnum = "desc"
)

// 商品排序参数：
type Productv4GetProductAttributesV4RequestSortByEnum string
const (
	Productv4GetProductAttributesV4RequestSortByEnum_Sku Productv4GetProductAttributesV4RequestSortByEnum = "sku"
	Productv4GetProductAttributesV4RequestSortByEnum_OfferId Productv4GetProductAttributesV4RequestSortByEnum = "offer_id"
	Productv4GetProductAttributesV4RequestSortByEnum_Id Productv4GetProductAttributesV4RequestSortByEnum = "id"
	Productv4GetProductAttributesV4RequestSortByEnum_Title Productv4GetProductAttributesV4RequestSortByEnum = "title"
)
...
type Productv4GetProductAttributesV4Request struct {
	...
	SortBy Productv4GetProductAttributesV4RequestSortByEnum `json:"sort_by"` // 商品排序参数： - `sku` — 按Ozon系统中的商品标识符排序； - `offer_id` — 按商品货号排序； - `id` — 按商品标识符排序； - `title` — 按商品名称排序。
	SortDir Productv4GetProductAttributesV4RequestSortDirEnum `json:"sort_dir"` // 排序方向： - `asc` — 升序， - `desc` — 降序。
}
...
// SKU商品的可用性表示：
type V1ProductGetRelatedSKUResponseItemAvailabilityEnum string
const (
	V1ProductGetRelatedSKUResponseItemAvailabilityEnum_HIDDEN V1ProductGetRelatedSKUResponseItemAvailabilityEnum = "HIDDEN"
	V1ProductGetRelatedSKUResponseItemAvailabilityEnum_AVAILABLE V1ProductGetRelatedSKUResponseItemAvailabilityEnum = "AVAILABLE"
	V1ProductGetRelatedSKUResponseItemAvailabilityEnum_UNAVAILABLE V1ProductGetRelatedSKUResponseItemAvailabilityEnum = "UNAVAILABLE"
)

// 配送计划：
type V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum string
const (
	V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum_SDS V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum = "SDS"
	V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum_FBO V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum = "FBO"
	V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum_FBS V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum = "FBS"
	V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum_Crossborder V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum = "Crossborder"
)

type V1ProductGetRelatedSKUResponseItem struct {
	ProductID int64 `json:"product_id"` // Ozon系统中商品的标识符 — `product_id`。
	SKU int64 `json:"sku"` // Ozon系统中的商品ID —— SKU。
	Availability V1ProductGetRelatedSKUResponseItemAvailabilityEnum `json:"availability"` // SKU商品的可用性表示： - `HIDDEN` —— 隐藏； - `AVAILABLE` —— 可用； - `UNAVAILABLE` —— 不可用，SKU已删除。
	DeletedAt string `json:"deleted_at"` // 删除日期和时间。
	DeliverySchema V1ProductGetRelatedSKUResponseItemDeliverySchemaEnum `json:"delivery_schema"` // 配送计划： - `SDS` — Ozon 通用 SKU 编号； - `FBO` — 来自 Ozon 仓库的商品编号； - `FBS` — 来自 FBS 仓库的商品编号； - `Crossborder` — 跨境销售商品编号。
}
