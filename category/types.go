...
const (
	LanguageLanguageDefault LanguageLanguage = "DEFAULT"
	LanguageLanguageRU      LanguageLanguage = "RU"
	LanguageLanguageEN      LanguageLanguage = "EN"
	LanguageLanguageTR      LanguageLanguage = "TR"
	LanguageLanguageZHHans  LanguageLanguage = "ZH_HANS"
)
