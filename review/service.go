...
// 问题列表
func (s *Service) List(ctx context.Context, req *V1QuestionListRequest) (*V1QuestionListResponse, error) {
...
// 获取评价列表
func (s *Service) ReviewListV2(ctx context.Context, req *ReviewV2ReviewListV2Request) (*ReviewV2ReviewListV2Response, error) {
...
// 问题回答列表
func (s *Service) ListV1(ctx context.Context, req *V1QuestionAnswerListRequest) (*V1QuestionAnswerListResponse, error) {
