...
// 问题状态：
type V1QuestionInfoResponseStatusEnum string
const (
	V1QuestionInfoResponseStatusEnum_NEW V1QuestionInfoResponseStatusEnum = "NEW"
	V1QuestionInfoResponseStatusEnum_ALL V1QuestionInfoResponseStatusEnum = "ALL"
	V1QuestionInfoResponseStatusEnum_VIEWED V1QuestionInfoResponseStatusEnum = "VIEWED"
	V1QuestionInfoResponseStatusEnum_PROCESSED V1QuestionInfoResponseStatusEnum = "PROCESSED"
	V1QuestionInfoResponseStatusEnum_UNPROCESSED V1QuestionInfoResponseStatusEnum = "UNPROCESSED"
)
...
// 问题状态：
type V1QuestionListResponseQuestionsStatusEnum string
const (
	V1QuestionListResponseQuestionsStatusEnum_NEW V1QuestionListResponseQuestionsStatusEnum = "NEW"
	V1QuestionListResponseQuestionsStatusEnum_ALL V1QuestionListResponseQuestionsStatusEnum = "ALL"
	V1QuestionListResponseQuestionsStatusEnum_VIEWED V1QuestionListResponseQuestionsStatusEnum = "VIEWED"
	V1QuestionListResponseQuestionsStatusEnum_PROCESSED V1QuestionListResponseQuestionsStatusEnum = "PROCESSED"
	V1QuestionListResponseQuestionsStatusEnum_UNPROCESSED V1QuestionListResponseQuestionsStatusEnum = "UNPROCESSED"
)
...
// 评价状态：
type V1ReviewChangeStatusRequestStatusEnum string
const (
	V1ReviewChangeStatusRequestStatusEnum_PROCESSED V1ReviewChangeStatusRequestStatusEnum = "PROCESSED"
	V1ReviewChangeStatusRequestStatusEnum_UNPROCESSED V1ReviewChangeStatusRequestStatusEnum = "UNPROCESSED"
)

type V1ReviewChangeStatusRequest struct {
	ReviewIds []string `json:"review_ids"` // 包含评价标识符的数组（数量在1到100之间）。
	Status V1ReviewChangeStatusRequestStatusEnum `json:"status"` // 评价状态： - `PROCESSED` — 已处理。 - `UNPROCESSED` — 未处理。
}
...
// 买家留下评价的订单状态：
type V1ReviewInfoResponseOrderStatusEnum string
const (
	V1ReviewInfoResponseOrderStatusEnum_DELIVERED V1ReviewInfoResponseOrderStatusEnum = "DELIVERED"
	V1ReviewInfoResponseOrderStatusEnum_CANCELLED V1ReviewInfoResponseOrderStatusEnum = "CANCELLED"
)

// 评价状态：
type V1ReviewInfoResponseStatusEnum string
const (
	V1ReviewInfoResponseStatusEnum_UNPROCESSED V1ReviewInfoResponseStatusEnum = "UNPROCESSED"
	V1ReviewInfoResponseStatusEnum_PROCESSED V1ReviewInfoResponseStatusEnum = "PROCESSED"
)
...
type V1ReviewInfoResponse struct {
	...
	Status V1ReviewInfoResponseStatusEnum `json:"status"` // 评价状态： - `UNPROCESSED` — 未处理， - `PROCESSED` — 已处理。
	Videos []ReviewInfoResponseVideo `json:"videos"` // 视频信息。
	CommentsAmount int32 `json:"comments_amount"` // 评价的回复数量。
	ID string `json:"id"` // 评价标识符。
	OrderStatus V1ReviewInfoResponseOrderStatusEnum `json:"order_status"` // 买家留下评价的订单状态： - `DELIVERED`— 已送达， - `CANCELLED` — 已取消。
	PhotosAmount int32 `json:"photos_amount"` // 评价中的图片数量。
...
// 筛选器。
// 问题状态：
type V1QuestionListRequestFilterStatusEnum string
const (
	V1QuestionListRequestFilterStatusEnum_NEW V1QuestionListRequestFilterStatusEnum = "NEW"
	V1QuestionListRequestFilterStatusEnum_ALL V1QuestionListRequestFilterStatusEnum = "ALL"
	V1QuestionListRequestFilterStatusEnum_VIEWED V1QuestionListRequestFilterStatusEnum = "VIEWED"
	V1QuestionListRequestFilterStatusEnum_PROCESSED V1QuestionListRequestFilterStatusEnum = "PROCESSED"
	V1QuestionListRequestFilterStatusEnum_UNPROCESSED V1QuestionListRequestFilterStatusEnum = "UNPROCESSED"
)

type V1QuestionListRequestFilter struct {
	DateFrom string `json:"date_from"` // 时间段开始。
	DateTo string `json:"date_to"` // 时间段结束。
	Status V1QuestionListRequestFilterStatusEnum `json:"status"` // 问题状态： - `NEW`——新的， - `ALL`——全部问题， - `VIEWED`——已查看， - `PROCESSED`——已处理， - `UNPROCESSED`——未处理。
}
...
// 买家留下评价的订单状态：
type ReviewListResponseReviewOrderStatusEnum string
const (
	ReviewListResponseReviewOrderStatusEnum_DELIVERED ReviewListResponseReviewOrderStatusEnum = "DELIVERED"
	ReviewListResponseReviewOrderStatusEnum_CANCELLED ReviewListResponseReviewOrderStatusEnum = "CANCELLED"
)

// 评价状态：
type ReviewListResponseReviewStatusEnum string
const (
	ReviewListResponseReviewStatusEnum_UNPROCESSED ReviewListResponseReviewStatusEnum = "UNPROCESSED"
	ReviewListResponseReviewStatusEnum_PROCESSED ReviewListResponseReviewStatusEnum = "PROCESSED"
)
...
type ReviewListResponseReview struct {
	...
	OrderStatus ReviewListResponseReviewOrderStatusEnum `json:"order_status"` // 买家留下评价的订单状态： - `DELIVERED`— 已送达， - `CANCELLED` — 已取消。
	Rating int32 `json:"rating"` // 评价的评分。
	SKU int64 `json:"sku"` // Ozon系统中的商品识别符——SKU。
	Status ReviewListResponseReviewStatusEnum `json:"status"` // 评价状态： - `UNPROCESSED` — 未处理， - `PROCESSED` — 已处理。
	Text string `json:"text"` // 评价文字。
...
// 排序方向：
type V1ReviewListRequestSortDirEnum string
const (
	V1ReviewListRequestSortDirEnum_ASC V1ReviewListRequestSortDirEnum = "ASC"
	V1ReviewListRequestSortDirEnum_DESC V1ReviewListRequestSortDirEnum = "DESC"
)

// 评价状态：
type V1ReviewListRequestStatusEnum string
const (
	V1ReviewListRequestStatusEnum_ALL V1ReviewListRequestStatusEnum = "ALL"
	V1ReviewListRequestStatusEnum_UNPROCESSED V1ReviewListRequestStatusEnum = "UNPROCESSED"
	V1ReviewListRequestStatusEnum_PROCESSED V1ReviewListRequestStatusEnum = "PROCESSED"
)

type V1ReviewListRequest struct {
	LastID string `json:"last_id"` // 页面中最后一个评价的标识符。
	Limit int32 `json:"limit"` // 限制回复中的值数量。最少 — 20；最多 — 100。
	SortDir V1ReviewListRequestSortDirEnum `json:"sort_dir"` // 排序方向： - `ASC` — 按升序。 - `DESC` — 按降序。
	Status V1ReviewListRequestStatusEnum `json:"status"` // 评价状态： - `ALL` — 全部， - `UNPROCESSED` — 未处理的， - `PROCESSED` — 已处理的。
}
...
// 问题状态：
type V1QuestionChangeStatusRequestStatusEnum string
const (
	V1QuestionChangeStatusRequestStatusEnum_NEW V1QuestionChangeStatusRequestStatusEnum = "NEW"
	V1QuestionChangeStatusRequestStatusEnum_VIEWED V1QuestionChangeStatusRequestStatusEnum = "VIEWED"
	V1QuestionChangeStatusRequestStatusEnum_PROCESSED V1QuestionChangeStatusRequestStatusEnum = "PROCESSED"
)

type V1QuestionChangeStatusRequest struct {
	QuestionIds []string `json:"question_ids"` // 问题标识符。
	Status V1QuestionChangeStatusRequestStatusEnum `json:"status"` // 问题状态： - `NEW`——新的， - `VIEWED`——已查看， - `PROCESSED`——已处理。
}
