...
type V1SellerActionsListResponse struct {
	Actions []SellerActionsListResponseAction `json:"actions"` // 促销活动列表。
...
type V1SellerActionsUpdateMultiLevelDiscountRequestActionParameters struct {
	DateEnd string `json:"date_end"` // 促销活动结束日期与时间。
	DateStart string `json:"date_start"` // 促销活动开始日期与时间。
	DiscountLevels []SellerActionsUpdateMultiLevelDiscountRequestActionParametersDiscountLevel `json:"discount_levels"` // 折扣等级。
...
// 促销活动状态：
type V1SellerActionsListRequestStatusEnum string
const (
	V1SellerActionsListRequestStatusEnum_ACTIVE V1SellerActionsListRequestStatusEnum = "ACTIVE"
	V1SellerActionsListRequestStatusEnum_ENDED V1SellerActionsListRequestStatusEnum = "ENDED"
	V1SellerActionsListRequestStatusEnum_PLANNED V1SellerActionsListRequestStatusEnum = "PLANNED"
	V1SellerActionsListRequestStatusEnum_PAUSED V1SellerActionsListRequestStatusEnum = "PAUSED"
)

// 促销活动机制：
type V1SellerActionsListRequestActionTypeEnum string
const (
	V1SellerActionsListRequestActionTypeEnum_DISCOUNT V1SellerActionsListRequestActionTypeEnum = "DISCOUNT"
	V1SellerActionsListRequestActionTypeEnum_VOUCHERDISCOUNT V1SellerActionsListRequestActionTypeEnum = "VOUCHER_DISCOUNT"
	V1SellerActionsListRequestActionTypeEnum_DISCOUNTWITHCONDITION V1SellerActionsListRequestActionTypeEnum = "DISCOUNT_WITH_CONDITION"
	V1SellerActionsListRequestActionTypeEnum_INSTALLMENT V1SellerActionsListRequestActionTypeEnum = "INSTALLMENT"
	V1SellerActionsListRequestActionTypeEnum_INDIVIDUALDISCOUNTBYPRODUCTS V1SellerActionsListRequestActionTypeEnum = "INDIVIDUAL_DISCOUNT_BY_PRODUCTS"
	V1SellerActionsListRequestActionTypeEnum_OZONACCOUNTDISCOUNT V1SellerActionsListRequestActionTypeEnum = "OZON_ACCOUNT_DISCOUNT"
	V1SellerActionsListRequestActionTypeEnum_MULTILEVELDISCOUNTONAMOUNT V1SellerActionsListRequestActionTypeEnum = "MULTI_LEVEL_DISCOUNT_ON_AMOUNT"
)

type V1SellerActionsListRequest struct {
	Search string `json:"search"` // 按促销活动名称搜索。
	Status []SellerActionsListRequestStatusEnum `json:"status"` // 促销活动状态： - `ACTIVE`—— 活跃； - `ENDED`——已结束； - `PLANNED`——已计划； - `PAUSED`——已暂停。
	ActionIds []string `json:"action_ids"` // 促销活动标识符列表。
	ActionType []SellerActionsListRequestActionTypeEnum `json:"action_type"` // 促销活动机制： - `DISCOUNT`——折扣； - `VOUCHER_DISCOUNT`——促销码折扣； - `DISCOUNT_WITH_CONDITION`——基于订单总额的折扣； - `INSTALLMENT`——免息分期付款； ...
...
// 商品加入促销活动的方式：
type ActionsV1ActionsAutoAddProductsListResponseProductsAddModeEnum string
const (
	ActionsV1ActionsAutoAddProductsListResponseProductsAddModeEnum_AUTO ActionsV1ActionsAutoAddProductsListResponseProductsAddModeEnum = "AUTO"
	ActionsV1ActionsAutoAddProductsListResponseProductsAddModeEnum_MANUAL ActionsV1ActionsAutoAddProductsListResponseProductsAddModeEnum = "MANUAL"
)

type ActionsV1ActionsAutoAddProductsListResponseProducts struct {
	AddMode ActionsV1ActionsAutoAddProductsListResponseProductsAddModeEnum `json:"add_mode"` // 商品加入促销活动的方式： - `AUTO`——自动； - `MANUAL`——卖家手动。
	Currency string `json:"currency"` // 价格货币。
	MinActionQuantity int64 `json:"min_action_quantity"` // “库存折扣”促销活动类型中的最低商品数量。
	MinSellerPrice float64 `json:"min_seller_price"` // 应用促销活动后的商品最低价格。
	Price float64 `json:"price"` // 商品无折扣价格。
