...
type V1SellerActionsProductsCandidatesResponseProductQuantType string

const (
	V1SellerActionsProductsCandidatesResponseProductQuantTypeUnspecified V1SellerActionsProductsCandidatesResponseProductQuantType = "UNSPECIFIED"
	V1SellerActionsProductsCandidatesResponseProductQuantTypeBOX         V1SellerActionsProductsCandidatesResponseProductQuantType = "BOX"
	V1SellerActionsProductsCandidatesResponseProductQuantTypePallet      V1SellerActionsProductsCandidatesResponseProductQuantType = "PALLET"
	V1SellerActionsProductsCandidatesResponseProductQuantTypeGeneral     V1SellerActionsProductsCandidatesResponseProductQuantType = "GENERAL"
)
...
type ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCode string

const (
	ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCodeNOTFound           ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCode = "NOT_FOUND"
	ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCodeNOChanges          ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCode = "NO_CHANGES"
	ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCodeStockRequired      ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCode = "STOCK_REQUIRED"
	ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCodeInvalidActionPrice ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCode = "INVALID_ACTION_PRICE"
	ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCodeMAXActionPrice     ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCode = "MAX_ACTION_PRICE"
	ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCodeRejectedLOWPrice   ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCode = "REJECTED_LOW_PRICE"
	ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCodeInvalidCurrency    ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCode = "INVALID_CURRENCY"
)

type ActionsV1ActionsAutoAddProductsUpdateResponseRejected struct {
	Code      ActionsV1ActionsAutoAddProductsUpdateResponseRejectedCode `json:"code"`
...
type ActionsListRequestStatus string

const (
	ActionsListRequestStatusActive  ActionsListRequestStatus = "ACTIVE"
	ActionsListRequestStatusEnded   ActionsListRequestStatus = "ENDED"
	ActionsListRequestStatusPlanned ActionsListRequestStatus = "PLANNED"
	ActionsListRequestStatusPaused  ActionsListRequestStatus = "PAUSED"
)

// 促销码类型： - `ONE`——面向所有买家的促销码，可用于1个订单； - `MULTIPLE`——面向所有买家的促销码，可用于任意数量的订单； - `UNIQUE`——面向1位买家的促销码，可用于1个订单。
type V1SellerActionsCreateVoucherRequestVoucherParameterType string

const (
	V1SellerActionsCreateVoucherRequestVoucherParameterTypeONE      V1SellerActionsCreateVoucherRequestVoucherParameterType = "ONE"
	V1SellerActionsCreateVoucherRequestVoucherParameterTypeMultiple V1SellerActionsCreateVoucherRequestVoucherParameterType = "MULTIPLE"
	V1SellerActionsCreateVoucherRequestVoucherParameterTypeUnique   V1SellerActionsCreateVoucherRequestVoucherParameterType = "UNIQUE"
)

// 折扣类型： - `PERCENT`——百分比折扣； - `CURRENCY`——按金额折扣。
type V1SellerActionsCreateVoucherRequestDiscountType string

const (
	V1SellerActionsCreateVoucherRequestDiscountTypePercent  V1SellerActionsCreateVoucherRequestDiscountType = "PERCENT"
	V1SellerActionsCreateVoucherRequestDiscountTypeCurrency V1SellerActionsCreateVoucherRequestDiscountType = "CURRENCY"
)
...
// 定量包装类型： - `UNSPECIFIED`——未指定， - `BOX`——箱， - `PALLET`——托盘， - `GENERAL`——商品。
type V1SellerActionsProductsListResponseProductQuantType string

const (
	V1SellerActionsProductsListResponseProductQuantTypeUnspecified V1SellerActionsProductsListResponseProductQuantType = "UNSPECIFIED"
	V1SellerActionsProductsListResponseProductQuantTypeBOX         V1SellerActionsProductsListResponseProductQuantType = "BOX"
	V1SellerActionsProductsListResponseProductQuantTypePallet      V1SellerActionsProductsListResponseProductQuantType = "PALLET"
	V1SellerActionsProductsListResponseProductQuantTypeGeneral     V1SellerActionsProductsListResponseProductQuantType = "GENERAL"
)
...
type V1SellerActionsProductsListResponseProduct struct {
	...
	QuantType       V1SellerActionsProductsListResponseProductQuantType `json:"quant_type"`
...
type PickedSegmentSegmentType string

const (
	PickedSegmentSegmentTypeUnspecified PickedSegmentSegmentType = "UNSPECIFIED"
	PickedSegmentSegmentTypeOzon        PickedSegmentSegmentType = "OZON"
	PickedSegmentSegmentTypeSeller      PickedSegmentSegmentType = "SELLER"
)
...
type PickedSegmentSegment struct {
	...
	Type        PickedSegmentSegmentType `json:"type_"`
}
...
type V1SellerActionsCreateVoucherRequestVoucherParameter struct {
	...
	Type       V1SellerActionsCreateVoucherRequestVoucherParameterType `json:"type_"`
}

type V1SellerActionsCreateVoucherRequest struct {
	DateStart         string                                              `json:"date_start"` // 促销活动开始日期与时间。
	DiscountType      V1SellerActionsCreateVoucherRequestDiscountType     `json:"discount_type"`
	DiscountValue     float64                                             `json:"discount_value"` // 折扣幅度。
	Title             string                                              `json:"title"`          // 促销活动名称。
	UserIds           []string                                            `json:"user_ids"`       // 可使用该促销码的用户标识符列表。
...
type ActionParameterVoucherParameterType string

const (
	ActionParameterVoucherParameterTypeUnspecified ActionParameterVoucherParameterType = "UNSPECIFIED"
	ActionParameterVoucherParameterTypeONE         ActionParameterVoucherParameterType = "ONE"
	ActionParameterVoucherParameterTypeMultiple    ActionParameterVoucherParameterType = "MULTIPLE"
	ActionParameterVoucherParameterTypeUnique      ActionParameterVoucherParameterType = "UNIQUE"
)

// 促销码参数。
type ActionParameterVoucherParameter struct {
	IsPrivate  bool                                `json:"is_private"` // `true`，表示促销码不公开。
	Type       ActionParameterVoucherParameterType `json:"type_"`
...
type ParameterAutoStopActionReason string

const (
	ParameterAutoStopActionReasonUnspecified           ParameterAutoStopActionReason = "UNSPECIFIED"
	ParameterAutoStopActionReasonBudgetExceeded        ParameterAutoStopActionReason = "BUDGET_EXCEEDED"
	ParameterAutoStopActionReasonFastBudgetSpending    ParameterAutoStopActionReason = "FAST_BUDGET_SPENDING"
	ParameterAutoStopActionReasonBudgetSpendingISCrazy ParameterAutoStopActionReason = "BUDGET_SPENDING_IS_CRAZY"
)

// 折扣类型： - `UNSPECIFIED`——未定义； - `RUB`——以卢布计的折扣； - `PERCENT`——百分比折扣； - `FINAL_PRICE`——最终价格； - `INSTALLED_PERIOD`——分期付款周期； -...
type ActionParameterDiscountType string

const (
	ActionParameterDiscountTypeUnspecified     ActionParameterDiscountType = "UNSPECIFIED"
	ActionParameterDiscountTypeRUB             ActionParameterDiscountType = "RUB"
	ActionParameterDiscountTypePercent         ActionParameterDiscountType = "PERCENT"
	ActionParameterDiscountTypeFinalPrice      ActionParameterDiscountType = "FINAL_PRICE"
	ActionParameterDiscountTypeInstalledPeriod ActionParameterDiscountType = "INSTALLED_PERIOD"
	ActionParameterDiscountTypeCurrency        ActionParameterDiscountType = "CURRENCY"
)

// 促销活动机制： - `DISCOUNT`——折扣； - `VOUCHER_DISCOUNT`——促销码折扣； - `DISCOUNT_WITH_CONDITION`——基于订单总额的折扣； - `INSTALLMENT`——免息分期付款； ...
type ActionsListRequestActionType string

const (
	ActionsListRequestActionTypeDiscount                     ActionsListRequestActionType = "DISCOUNT"
	ActionsListRequestActionTypeVoucherDiscount              ActionsListRequestActionType = "VOUCHER_DISCOUNT"
	ActionsListRequestActionTypeDiscountWithCondition        ActionsListRequestActionType = "DISCOUNT_WITH_CONDITION"
	ActionsListRequestActionTypeInstallment                  ActionsListRequestActionType = "INSTALLMENT"
	ActionsListRequestActionTypeIndividualDiscountBYProducts ActionsListRequestActionType = "INDIVIDUAL_DISCOUNT_BY_PRODUCTS"
	ActionsListRequestActionTypeOzonAccountDiscount          ActionsListRequestActionType = "OZON_ACCOUNT_DISCOUNT"
	ActionsListRequestActionTypeMultiLevelDiscountONAmount   ActionsListRequestActionType = "MULTI_LEVEL_DISCOUNT_ON_AMOUNT"
)
...
type ActionParameter struct {
	...
	AutoStopActionReason   ParameterAutoStopActionReason   `json:"auto_stop_action_reason"`
	BudgetSpent            float64                         `json:"budget_spent"` // 促销活动预算支出。
	DiscountType           ActionParameterDiscountType     `json:"discount_type"`
	IsLegalEntitiesSegment bool                            `json:"is_legal_entities_segment"` // `true`，表示该促销活动面向企业客户。
	Status                 ActionsListRequestStatus        `json:"status"`
	Title                  string                          `json:"title"`            // 促销活动名称。
	...
	Type                   ActionsListRequestActionType    `json:"type_"`
}
...
const (
	V1DiscountTaskStatusNEW            V1DiscountTaskStatus = "NEW"
	V1DiscountTaskStatusSeen           V1DiscountTaskStatus = "SEEN"
	V1DiscountTaskStatusApproved       V1DiscountTaskStatus = "APPROVED"
	V1DiscountTaskStatusPartlyApproved V1DiscountTaskStatus = "PARTLY_APPROVED"
	V1DiscountTaskStatusDeclined       V1DiscountTaskStatus = "DECLINED"
	V1DiscountTaskStatusAutoDeclined   V1DiscountTaskStatus = "AUTO_DECLINED"
	V1DiscountTaskStatusDeclinedBYUser V1DiscountTaskStatus = "DECLINED_BY_USER"
	V1DiscountTaskStatusCoupon         V1DiscountTaskStatus = "COUPON"
	V1DiscountTaskStatusPurchased      V1DiscountTaskStatus = "PURCHASED"
)
...
// Currency is provided by the enum package.

type V1SellerActionsProductsAddRequestProduct struct {
	Currency        enum.CurrencyCode `json:"currency"`
...
// 折扣类型： - `PERCENT`——百分比折扣； - `CURRENCY`——按金额折扣。
type V1SellerActionsCreateDiscountWithConditionRequestDiscountType string

const (
	V1SellerActionsCreateDiscountWithConditionRequestDiscountTypePercent  V1SellerActionsCreateDiscountWithConditionRequestDiscountType = "PERCENT"
	V1SellerActionsCreateDiscountWithConditionRequestDiscountTypeCurrency V1SellerActionsCreateDiscountWithConditionRequestDiscountType = "CURRENCY"
)
...
// 折扣类型： - `PERCENT`——百分比折扣； - `CURRENCY`——按金额折扣。
type V1SellerActionsCreateMultiLevelDiscountRequestDiscountType string

const (
	V1SellerActionsCreateMultiLevelDiscountRequestDiscountTypePercent  V1SellerActionsCreateMultiLevelDiscountRequestDiscountType = "PERCENT"
	V1SellerActionsCreateMultiLevelDiscountRequestDiscountTypeCurrency V1SellerActionsCreateMultiLevelDiscountRequestDiscountType = "CURRENCY"
)
...
type V1SellerActionsProductsCandidatesResponseProduct struct {
	ProductID       int64                                                     `json:"product_id"` // Ozon系统中的商品标识符——`product_id`。
	QuantSize       int64                                                     `json:"quant_size"` // 定量包装大小。
	QuantType       V1SellerActionsProductsCandidatesResponseProductQuantType `json:"quant_type"`
	ActionPrice     float64                                                   `json:"action_price"`     // 计入促销活动后的商品价格。
	BasePrice       float64                                                   `json:"base_price"`       // 商品未参与促销活动时在Ozon上的基本价格。
	Currency        string                                                    `json:"currency"`         // 货币单位。
	DiscountPercent float64                                                   `json:"discount_percent"` // 折扣百分比。
...
type V1SellerActionsListRequest struct {
	...
	ActionType []ActionsListRequestActionType `json:"action_type"` // 促销活动机制： - `DISCOUNT`——折扣； - `VOUCHER_DISCOUNT`——促销码折扣； - `DISCOUNT_WITH_CONDITION`——基于订单总额的折扣； - `INSTALLMENT`——免息分期付款； ...
	...
	Status     []ActionsListRequestStatus     `json:"status"`      // 促销活动状态： - `ACTIVE`—— 活跃； - `ENDED`——已结束； - `PLANNED`——已计划； - `PAUSED`——已暂停。
}
...
type V1SellerActionsCreateMultiLevelDiscountRequest struct {
	...
	DiscountType           V1SellerActionsCreateMultiLevelDiscountRequestDiscountType    `json:"discount_type"`
	IsLegalEntitiesSegment bool                                                          `json:"is_legal_entities_segment"` // `true`，表示促销活动仅面向法人实体。
}
...
type V1SellerActionsCreateDiscountWithConditionRequest struct {
	DiscountType   V1SellerActionsCreateDiscountWithConditionRequestDiscountType `json:"discount_type"`
	DiscountValue  float64                                                       `json:"discount_value"`   // 折扣幅度。
	MinOrderAmount float64                                                       `json:"min_order_amount"` // 折扣生效的订单金额门槛。
	Title          string                                                        `json:"title"`            // 促销活动名称。
	DateEnd        string                                                        `json:"date_end"`         // 促销活动结束日期与时间。
